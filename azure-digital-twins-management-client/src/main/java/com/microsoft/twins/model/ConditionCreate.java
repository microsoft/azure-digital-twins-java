...
public class ConditionCreate {
  ...
  public ConditionCreate target(final TargetEnum target) {
    this.target = target;
    return this;
  }
  ...
  public ConditionCreate path(final String path) {
    this.path = path;
    return this;
  }
  ...
  public ConditionCreate value(final String value) {
    this.value = value;
    return this;
  }
  ...
  public ConditionCreate comparison(final ComparisonEnum comparison) {
