...
public class UserCreate {
  ...
  public UserCreate upn(final String upn) {
    this.upn = upn;
    return this;
  }
  ...
  public UserCreate location(final Location location) {
  ...
  public UserCreate firstName(final String firstName) {
  ...
  public UserCreate lastName(final String lastName) {
  ...
  public UserCreate managerName(final String managerName) {
  ...
  public UserCreate metadata(final Map<String, String> metadata) {
    this.metadata = metadata;
    return this;
  }

  public UserCreate putMetadataItem(final String key, final String metadataItem) {
  ...
  public UserCreate properties(final List<ExtendedPropertyCreate> properties) {
    this.properties = properties;
    return this;
  }

  public UserCreate addPropertiesItem(final ExtendedPropertyCreate propertiesItem) {
