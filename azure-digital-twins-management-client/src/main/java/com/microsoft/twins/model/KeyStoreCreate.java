...
public class KeyStoreCreate {
  ...
  public KeyStoreCreate name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public KeyStoreCreate description(final String description) {
  ...
  public KeyStoreCreate spaceId(final UUID spaceId) {
