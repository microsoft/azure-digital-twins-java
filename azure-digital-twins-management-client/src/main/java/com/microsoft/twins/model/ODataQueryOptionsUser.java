...
public class ODataQueryOptionsUser {
  ...
  public ODataQueryOptionsUser context(final ODataQueryContext context) {
  ...
  public ODataQueryOptionsUser rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsUser selectExpand(final SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsUser filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsUser orderBy(final OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsUser skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsUser top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsUser inlineCount(final InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsUser validator(final ODataQueryValidator validator) {
