...
public class TopQueryOption {
  ...
  private TopQueryValidator validator;

  public TopQueryOption context(final ODataQueryContext context) {
  ...
  public TopQueryOption validator(final TopQueryValidator validator) {
   ...
   **/
  @Valid
  public TopQueryValidator getValidator() {
    return validator;
  }

  public void setValidator(final TopQueryValidator validator) {
    this.validator = validator;
  }
