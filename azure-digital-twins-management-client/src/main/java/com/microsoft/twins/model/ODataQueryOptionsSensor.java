...
public class ODataQueryOptionsSensor {
  ...
  public ODataQueryOptionsSensor context(final ODataQueryContext context) {
  ...
  public ODataQueryOptionsSensor rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsSensor selectExpand(final SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsSensor filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsSensor orderBy(final OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsSensor skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsSensor top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsSensor inlineCount(final InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsSensor validator(final ODataQueryValidator validator) {
