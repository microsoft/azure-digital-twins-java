...
@ToString
@EqualsAndHashCode
public class UserDefinedFunctionRetrieve extends AbstractRetrieve<UserDefinedFunctionRetrieve> {
  ...
  private List<MatcherRetrieve> matchers;
  @JsonProperty("contentInfo")
  private BlobMetadataContentInfo contentInfo;

  public UserDefinedFunctionRetrieve spaceId(final UUID spaceId) {
  ...
  public UserDefinedFunctionRetrieve space(final SpaceRetrieve space) {
    this.space = space;
    return this;
  }
  ...
  public UserDefinedFunctionRetrieve name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public UserDefinedFunctionRetrieve disabled(final Boolean disabled) {
  ...
  public UserDefinedFunctionRetrieve friendlyName(final String friendlyName) {
  ...
  public UserDefinedFunctionRetrieve description(final String description) {
  ...
  public UserDefinedFunctionRetrieve fullName(final String fullName) {
  ...
  public UserDefinedFunctionRetrieve spacePaths(final List<String> spacePaths) {
    this.spacePaths = spacePaths;
    return this;
  }

  public UserDefinedFunctionRetrieve addSpacePathsItem(final String spacePathsItem) {
  ...
  public UserDefinedFunctionRetrieve matchers(final List<MatcherRetrieve> matchers) {
    this.matchers = matchers;
    return this;
  }

  public UserDefinedFunctionRetrieve addMatchersItem(final MatcherRetrieve matchersItem) {
   ...
   **/
  @Valid
  public List<MatcherRetrieve> getMatchers() {
    return matchers;
  }

  public void setMatchers(final List<MatcherRetrieve> matchers) {
    this.matchers = matchers;
  }

  public UserDefinedFunctionRetrieve contentInfo(final BlobMetadataContentInfo contentInfo) {
  ...
  public void setContentInfo(final BlobMetadataContentInfo contentInfo) {
    this.contentInfo = contentInfo;
  }
}
