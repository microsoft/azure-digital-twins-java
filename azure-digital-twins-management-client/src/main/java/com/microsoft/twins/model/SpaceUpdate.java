...
public class SpaceUpdate {
  ...
  public SpaceUpdate name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public SpaceUpdate description(final String description) {
  ...
  public SpaceUpdate friendlyName(final String friendlyName) {
  ...
  public SpaceUpdate type(final String type) {
    this.type = type;
    return this;
  }
  ...
  public SpaceUpdate typeId(final Integer typeId) {
    this.typeId = typeId;
    return this;
  }
  ...
  public SpaceUpdate parentSpaceId(final UUID parentSpaceId) {
  ...
  public SpaceUpdate subtype(final String subtype) {
  ...
  public SpaceUpdate subtypeId(final Integer subtypeId) {
  ...
  public SpaceUpdate location(final Location location) {
  ...
  public SpaceUpdate timeZoneId(final Integer timeZoneId) {
  ...
  public SpaceUpdate timeZoneName(final String timeZoneName) {
  ...
  public SpaceUpdate status(final String status) {
    this.status = status;
    return this;
  }
  ...
  public SpaceUpdate statusId(final Integer statusId) {
