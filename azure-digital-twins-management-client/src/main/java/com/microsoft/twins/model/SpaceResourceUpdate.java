...
public class SpaceResourceUpdate {
  ...
  public SpaceResourceUpdate spaceId(final UUID spaceId) {
  ...
  public SpaceResourceUpdate size(final SizeEnum size) {
    this.size = size;
    return this;
  }
  ...
  public SpaceResourceUpdate parameters(final Map<String, String> parameters) {
    this.parameters = parameters;
    return this;
  }

  public SpaceResourceUpdate putParametersItem(final String key, final String parametersItem) {
  ...
  public SpaceResourceUpdate status(final StatusEnum status) {
    this.status = status;
    return this;
  }
