...
public class OrderByQueryOption {
  ...
  private OrderByQueryValidator validator;
  @JsonProperty("orderByClause")
  private OrderByClause orderByClause;

  public OrderByQueryOption context(final ODataQueryContext context) {
  ...
  public OrderByQueryOption validator(final OrderByQueryValidator validator) {
   ...
   **/
  @Valid
  public OrderByQueryValidator getValidator() {
    return validator;
  }

  public void setValidator(final OrderByQueryValidator validator) {
    this.validator = validator;
  }

  public OrderByQueryOption orderByClause(final OrderByClause orderByClause) {
  ...
  public void setOrderByClause(final OrderByClause orderByClause) {
    this.orderByClause = orderByClause;
  }
}
