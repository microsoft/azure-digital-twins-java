...
public class SecurityKeyRetrieve {
  ...
  public SecurityKeyRetrieve value(final String value) {
    this.value = value;
    return this;
  }
  ...
  public SecurityKeyRetrieve keyStoreId(final UUID keyStoreId) {
  ...
  public void setKeyStoreId(final UUID keyStoreId) {
    this.keyStoreId = keyStoreId;
  }

  public SecurityKeyRetrieve id(final Integer id) {
    this.id = id;
    return this;
  }
  ...
  public SecurityKeyRetrieve createdDateTimeUtc(final OffsetDateTime createdDateTimeUtc) {
  ...
  public void setCreatedDateTimeUtc(final OffsetDateTime createdDateTimeUtc) {
    this.createdDateTimeUtc = createdDateTimeUtc;
  }

  public SecurityKeyRetrieve status(final StatusEnum status) {
    this.status = status;
    return this;
  }
