...
public class Location {
  ...
  public Location longitude(final Double longitude) {
  ...
  public Location latitude(final Double latitude) {
  ...
  public Location elevation(final Double elevation) {
  ...
  public Location measure(final Double measure) {
    this.measure = measure;
    return this;
  }

  /**
   * Optional measure, in meters
   *
   * @return measure
   **/
