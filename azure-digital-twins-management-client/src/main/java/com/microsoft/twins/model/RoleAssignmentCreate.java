...
public class RoleAssignmentCreate {
  ...
  public RoleAssignmentCreate roleId(final UUID roleId) {
    this.roleId = roleId;
    return this;
  }
  ...
  public RoleAssignmentCreate objectId(final String objectId) {
  ...
  public RoleAssignmentCreate objectIdType(final ObjectIdTypeEnum objectIdType) {
  ...
  public RoleAssignmentCreate tenantId(final UUID tenantId) {
  ...
  public RoleAssignmentCreate path(final String path) {
    this.path = path;
    return this;
  }
