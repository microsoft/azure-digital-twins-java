...
public class SensorCreateNoParent {
  ...
  public SensorCreateNoParent port(final String port) {
    this.port = port;
    return this;
  }
  ...
  public SensorCreateNoParent pollRate(final Integer pollRate) {
  ...
  public SensorCreateNoParent dataType(final String dataType) {
  ...
  public SensorCreateNoParent type(final String type) {
    this.type = type;
    return this;
  }
  ...
  public SensorCreateNoParent portType(final String portType) {
  ...
  public SensorCreateNoParent dataUnitType(final String dataUnitType) {
  ...
  public SensorCreateNoParent dataSubtype(final String dataSubtype) {
  ...
  public SensorCreateNoParent spaceId(final UUID spaceId) {
  ...
  public SensorCreateNoParent location(final Location location) {
  ...
  public SensorCreateNoParent portTypeId(final Integer portTypeId) {
  ...
  public SensorCreateNoParent dataUnitTypeId(final Integer dataUnitTypeId) {
  ...
  public SensorCreateNoParent typeId(final Integer typeId) {
    this.typeId = typeId;
    return this;
  }
  ...
  public SensorCreateNoParent dataTypeId(final Integer dataTypeId) {
  ...
  public SensorCreateNoParent dataSubtypeId(final Integer dataSubtypeId) {
  ...
  public SensorCreateNoParent hardwareId(final String hardwareId) {
  ...
  public SensorCreateNoParent properties(final List<ExtendedPropertyCreate> properties) {
    this.properties = properties;
    return this;
  }

  public SensorCreateNoParent addPropertiesItem(final ExtendedPropertyCreate propertiesItem) {
