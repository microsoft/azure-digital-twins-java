...
public class ODataQueryOptionsKeyStore {
  ...
  public ODataQueryOptionsKeyStore context(final ODataQueryContext context) {
  ...
  public ODataQueryOptionsKeyStore rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsKeyStore selectExpand(final SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsKeyStore filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsKeyStore orderBy(final OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsKeyStore skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsKeyStore top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsKeyStore inlineCount(final InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsKeyStore validator(final ODataQueryValidator validator) {
