...
public class SkipQueryOption {
  ...
  public SkipQueryOption context(final ODataQueryContext context) {
  ...
  public SkipQueryOption validator(final SkipQueryValidator validator) {
  ...
  public void setValidator(final SkipQueryValidator validator) {
    this.validator = validator;
  }
}
