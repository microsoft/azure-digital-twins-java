...
public class SensorUpdate {
  ...
  public SensorUpdate port(final String port) {
    this.port = port;
    return this;
  }
  ...
  public SensorUpdate pollRate(final Integer pollRate) {
  ...
  public SensorUpdate dataType(final String dataType) {
  ...
  public SensorUpdate dataSubtype(final String dataSubtype) {
  ...
  public SensorUpdate type(final String type) {
    this.type = type;
    return this;
  }
  ...
  public SensorUpdate deviceId(final UUID deviceId) {
  ...
  public SensorUpdate spaceId(final UUID spaceId) {
  ...
  public SensorUpdate location(final Location location) {
  ...
  public SensorUpdate portType(final String portType) {
  ...
  public SensorUpdate dataUnitType(final String dataUnitType) {
  ...
  public SensorUpdate portTypeId(final Integer portTypeId) {
  ...
  public SensorUpdate dataUnitTypeId(final Integer dataUnitTypeId) {
  ...
  public SensorUpdate dataSubtypeId(final Integer dataSubtypeId) {
  ...
  public SensorUpdate typeId(final Integer typeId) {
    this.typeId = typeId;
    return this;
  }
  ...
  public SensorUpdate dataTypeId(final Integer dataTypeId) {
  ...
  public SensorUpdate hardwareId(final String hardwareId) {
