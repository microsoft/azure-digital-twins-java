...
public class ODataQueryOptionsMatcher {
  ...
  public ODataQueryOptionsMatcher context(final ODataQueryContext context) {
  ...
  public ODataQueryOptionsMatcher rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsMatcher selectExpand(final SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsMatcher filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsMatcher orderBy(final OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsMatcher skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsMatcher top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsMatcher inlineCount(final InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsMatcher validator(final ODataQueryValidator validator) {
