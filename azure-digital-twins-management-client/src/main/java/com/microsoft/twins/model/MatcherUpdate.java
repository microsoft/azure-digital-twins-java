...
public class MatcherUpdate {
  ...
  private List<ConditionUpdate> conditions;

  public MatcherUpdate name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public MatcherUpdate description(final String description) {
  ...
  public MatcherUpdate friendlyName(final String friendlyName) {
  ...
  public MatcherUpdate conditions(final List<ConditionUpdate> conditions) {
    this.conditions = conditions;
    return this;
  }

  public MatcherUpdate addConditionsItem(final ConditionUpdate conditionsItem) {
   ...
   **/
  @Valid
  public List<ConditionUpdate> getConditions() {
    return conditions;
  }

  public void setConditions(final List<ConditionUpdate> conditions) {
    this.conditions = conditions;
  }
}
