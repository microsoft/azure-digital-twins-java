...
public class RoleAssignmentRetrieve extends AbstractRetrieve<RoleAssignmentRetrieve> {
  ...
  /**
   * The type of the role assignment. With the exception of the DeviceId type, the types correspond to
   * properties of an AAD object. The DeviceId type corresponds to the device id in the topology. The
   * UserId type assigns a role to a user. The DeviceId type assigns a role to a device. The
  ...
  public enum ObjectIdTypeEnum {
    USERID("UserId"), DEVICEID("DeviceId"), DOMAINNAME("DomainName"), TENANTID("TenantId"), SERVICEPRINCIPALID(
  ...
  public RoleAssignmentRetrieve roleId(final UUID roleId) {
    this.roleId = roleId;
    return this;
  }
  ...
  public RoleAssignmentRetrieve objectId(final String objectId) {
  ...
  public RoleAssignmentRetrieve objectIdType(final ObjectIdTypeEnum objectIdType) {
  ...
  public void setObjectIdType(final ObjectIdTypeEnum objectIdType) {
    this.objectIdType = objectIdType;
  }

  public RoleAssignmentRetrieve tenantId(final UUID tenantId) {
  ...
  public RoleAssignmentRetrieve path(final String path) {
    this.path = path;
    return this;
  }
