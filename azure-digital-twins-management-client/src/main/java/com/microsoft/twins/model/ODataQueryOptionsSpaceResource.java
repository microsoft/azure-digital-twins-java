...
public class ODataQueryOptionsSpaceResource {
  ...
  public ODataQueryOptionsSpaceResource context(final ODataQueryContext context) {
  ...
  public ODataQueryOptionsSpaceResource rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsSpaceResource selectExpand(final SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsSpaceResource filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsSpaceResource orderBy(final OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsSpaceResource skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsSpaceResource top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsSpaceResource inlineCount(final InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsSpaceResource validator(final ODataQueryValidator validator) {
