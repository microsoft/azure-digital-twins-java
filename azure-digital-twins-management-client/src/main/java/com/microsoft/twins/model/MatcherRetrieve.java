...
@ToString
@EqualsAndHashCode
public class MatcherRetrieve extends AbstractRetrieve<MatcherRetrieve> {
  ...
  private List<ConditionRetrieve> conditions;
  @JsonProperty("userDefinedFunctions")
  private List<UserDefinedFunctionRetrieve> userDefinedFunctions;

  public MatcherRetrieve name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public MatcherRetrieve spaceId(final UUID spaceId) {
  ...
  public MatcherRetrieve space(final SpaceRetrieve space) {
    this.space = space;
    return this;
  }
  ...
  public MatcherRetrieve description(final String description) {
  ...
  public MatcherRetrieve friendlyName(final String friendlyName) {
  ...
  public MatcherRetrieve fullName(final String fullName) {
  ...
  public MatcherRetrieve spacePaths(final List<String> spacePaths) {
    this.spacePaths = spacePaths;
    return this;
  }

  public MatcherRetrieve addSpacePathsItem(final String spacePathsItem) {
  ...
  public MatcherRetrieve conditions(final List<ConditionRetrieve> conditions) {
    this.conditions = conditions;
    return this;
  }

  public MatcherRetrieve addConditionsItem(final ConditionRetrieve conditionsItem) {
   ...
   **/
  @Valid
  public List<ConditionRetrieve> getConditions() {
    return conditions;
  }

  public void setConditions(final List<ConditionRetrieve> conditions) {
    this.conditions = conditions;
  }
   ...
   **/
  @Valid
  public List<UserDefinedFunctionRetrieve> getUserDefinedFunctions() {
    return userDefinedFunctions;
  }
