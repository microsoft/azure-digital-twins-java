...
public class ODataQueryOptionsExtendedPropertyKey {
  ...
  public ODataQueryOptionsExtendedPropertyKey context(final ODataQueryContext context) {
  ...
  public ODataQueryOptionsExtendedPropertyKey rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsExtendedPropertyKey filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsExtendedPropertyKey orderBy(final OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsExtendedPropertyKey skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsExtendedPropertyKey top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsExtendedPropertyKey validator(final ODataQueryValidator validator) {
