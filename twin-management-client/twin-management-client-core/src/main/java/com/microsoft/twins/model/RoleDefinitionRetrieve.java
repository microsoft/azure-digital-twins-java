...
public class RoleDefinitionRetrieve extends AbstractRetrieve<RoleDefinitionRetrieve> {
  ...
  public RoleDefinitionRetrieve name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public RoleDefinitionRetrieve permissions(final List<Permission> permissions) {
    this.permissions = permissions;
    return this;
  }

  public RoleDefinitionRetrieve addPermissionsItem(final Permission permissionsItem) {
