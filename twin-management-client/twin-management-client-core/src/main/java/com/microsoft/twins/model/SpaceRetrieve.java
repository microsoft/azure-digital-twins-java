...
public class SpaceRetrieve extends AbstractRetrieve<SpaceRetrieve> {
  ...
  public SpaceRetrieve description(final String description) {
  ...
  public SpaceRetrieve friendlyName(final String friendlyName) {
  ...
  public SpaceRetrieve type(final String type) {
    this.type = type;
    return this;
  }
  ...
  public SpaceRetrieve typeId(final Integer typeId) {
    this.typeId = typeId;
    return this;
  }
  ...
  public SpaceRetrieve parentSpaceId(final UUID parentSpaceId) {
  ...
  public SpaceRetrieve subtype(final String subtype) {
  ...
  public SpaceRetrieve subtypeId(final Integer subtypeId) {
  ...
  public SpaceRetrieve location(final Location location) {
  ...
  public SpaceRetrieve timeZoneId(final Integer timeZoneId) {
  ...
  public SpaceRetrieve status(final String status) {
    this.status = status;
    return this;
  }
  ...
  public SpaceRetrieve statusId(final Integer statusId) {
  ...
  public SpaceRetrieve fullName(final String fullName) {
  ...
  public SpaceRetrieve spacePaths(final List<String> spacePaths) {
    this.spacePaths = spacePaths;
    return this;
  }

  public SpaceRetrieve addSpacePathsItem(final String spacePathsItem) {
  ...
  public SpaceRetrieve effectiveLocation(final Location effectiveLocation) {
  ...
  public SpaceRetrieve effectiveTimeZoneId(final Integer effectiveTimeZoneId) {
