...
public class ODataQueryOptionsSpaceBlobMetadata {
  ...
  public ODataQueryOptionsSpaceBlobMetadata context(final ODataQueryContext context) {
  ...
  public void setContext(final ODataQueryContext context) {
    this.context = context;
  }
  ...
  public ODataQueryOptionsSpaceBlobMetadata rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public void setRawValues(final ODataRawQueryOptions rawValues) {
    this.rawValues = rawValues;
  }

  public ODataQueryOptionsSpaceBlobMetadata selectExpand(final SelectExpandQueryOption selectExpand) {
  ...
  public void setSelectExpand(final SelectExpandQueryOption selectExpand) {
    this.selectExpand = selectExpand;
  }

  public ODataQueryOptionsSpaceBlobMetadata filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public void setFilter(final FilterQueryOption filter) {
    this.filter = filter;
  }

  public ODataQueryOptionsSpaceBlobMetadata orderBy(final OrderByQueryOption orderBy) {
  ...
  public void setOrderBy(final OrderByQueryOption orderBy) {
    this.orderBy = orderBy;
  }

  public ODataQueryOptionsSpaceBlobMetadata skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public void setSkip(final SkipQueryOption skip) {
    this.skip = skip;
  }

  public ODataQueryOptionsSpaceBlobMetadata top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public void setTop(final TopQueryOption top) {
    this.top = top;
  }

  public ODataQueryOptionsSpaceBlobMetadata inlineCount(final InlineCountQueryOption inlineCount) {
  ...
  public void setInlineCount(final InlineCountQueryOption inlineCount) {
    this.inlineCount = inlineCount;
  }

  public ODataQueryOptionsSpaceBlobMetadata validator(final ODataQueryValidator validator) {
  ...
  public void setValidator(final ODataQueryValidator validator) {
    this.validator = validator;
  }
}
