...
public class ODataQueryOptionsExtendedType {
  ...
  public ODataQueryOptionsExtendedType context(final ODataQueryContext context) {
  ...
  public ODataQueryOptionsExtendedType rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsExtendedType selectExpand(final SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsExtendedType filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsExtendedType orderBy(final OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsExtendedType skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsExtendedType top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsExtendedType inlineCount(final InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsExtendedType validator(final ODataQueryValidator validator) {
