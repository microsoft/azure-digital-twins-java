...
public class ODataQueryOptionsUserBlobMetadata {
  ...
  public ODataQueryOptionsUserBlobMetadata context(final ODataQueryContext context) {
  ...
  public ODataQueryOptionsUserBlobMetadata rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsUserBlobMetadata filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsUserBlobMetadata orderBy(final OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsUserBlobMetadata skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsUserBlobMetadata top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsUserBlobMetadata inlineCount(final InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsUserBlobMetadata validator(final ODataQueryValidator validator) {
