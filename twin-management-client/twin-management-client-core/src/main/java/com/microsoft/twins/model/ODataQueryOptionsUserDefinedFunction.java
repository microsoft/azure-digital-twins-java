...
public class ODataQueryOptionsUserDefinedFunction {
  ...
  public ODataQueryOptionsUserDefinedFunction context(final ODataQueryContext context) {
  ...
  public ODataQueryOptionsUserDefinedFunction rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsUserDefinedFunction filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsUserDefinedFunction orderBy(final OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsUserDefinedFunction skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsUserDefinedFunction top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsUserDefinedFunction validator(final ODataQueryValidator validator) {
