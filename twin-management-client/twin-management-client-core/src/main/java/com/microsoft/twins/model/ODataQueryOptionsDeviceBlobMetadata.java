...
public class ODataQueryOptionsDeviceBlobMetadata {
  ...
  public ODataQueryOptionsDeviceBlobMetadata context(final ODataQueryContext context) {
  ...
  public ODataQueryOptionsDeviceBlobMetadata rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsDeviceBlobMetadata filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsDeviceBlobMetadata orderBy(final OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsDeviceBlobMetadata skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsDeviceBlobMetadata top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsDeviceBlobMetadata inlineCount(final InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsDeviceBlobMetadata validator(final ODataQueryValidator validator) {
