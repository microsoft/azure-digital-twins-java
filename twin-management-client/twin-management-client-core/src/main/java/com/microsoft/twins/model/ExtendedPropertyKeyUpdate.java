...
public class ExtendedPropertyKeyUpdate {
  ...
  public ExtendedPropertyKeyUpdate name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public ExtendedPropertyKeyUpdate category(final String category) {
  ...
  public ExtendedPropertyKeyUpdate description(final String description) {
  ...
  public ExtendedPropertyKeyUpdate spaceId(final UUID spaceId) {
  ...
  public ExtendedPropertyKeyUpdate validationData(final String validationData) {
  ...
  public ExtendedPropertyKeyUpdate min(final String min) {
    this.min = min;
    return this;
  }
  ...
  public ExtendedPropertyKeyUpdate max(final String max) {
    this.max = max;
    return this;
  }
