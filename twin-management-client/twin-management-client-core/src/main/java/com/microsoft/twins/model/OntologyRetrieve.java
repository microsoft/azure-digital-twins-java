...
public class OntologyRetrieve {
  ...
  @JsonProperty("types")
  private List<ExtendedTypeRetrieve> types;

  public OntologyRetrieve id(final Integer id) {
    this.id = id;
    return this;
  }
  ...
  public OntologyRetrieve name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public OntologyRetrieve loaded(final Boolean loaded) {
    this.loaded = loaded;
    return this;
  }
  ...
  public OntologyRetrieve description(final String description) {
  ...
  public OntologyRetrieve types(final List<ExtendedTypeRetrieve> types) {
    this.types = types;
    return this;
  }

  public OntologyRetrieve addTypesItem(final ExtendedTypeRetrieve typesItem) {
    if (this.types == null) {
   ...
   **/
  @Valid
  public List<ExtendedTypeRetrieve> getTypes() {
    return types;
  }

  public void setTypes(final List<ExtendedTypeRetrieve> types) {
    this.types = types;
  }
}
