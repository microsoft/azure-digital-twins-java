...
public class TreeFilterModel {
  ...
  public TreeFilterModel spaceId(final UUID spaceId) {
  ...
  public TreeFilterModel traverse(final TraverseEnum traverse) {
  ...
  public TreeFilterModel minLevel(final Integer minLevel) {
  ...
  public TreeFilterModel maxLevel(final Integer maxLevel) {
  ...
  public TreeFilterModel minRelative(final Boolean minRelative) {
  ...
  public TreeFilterModel maxRelative(final Boolean maxRelative) {
