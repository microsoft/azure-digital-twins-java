...
public class FilterQueryOption {
  ...
  private FilterQueryValidator validator;
  @JsonProperty("filterClause")
  private FilterClause filterClause;
  @JsonProperty("rawValue")
  private String rawValue;

  public FilterQueryOption context(final ODataQueryContext context) {
  ...
  public FilterQueryOption validator(final FilterQueryValidator validator) {
   ...
   **/
  @Valid
  public FilterQueryValidator getValidator() {
    return validator;
  }

  public void setValidator(final FilterQueryValidator validator) {
    this.validator = validator;
  }

  public FilterQueryOption filterClause(final FilterClause filterClause) {
