...
public class ExtendedPropertyKeyCreate {
  ...
  public ExtendedPropertyKeyCreate name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public ExtendedPropertyKeyCreate category(final String category) {
  ...
  public ExtendedPropertyKeyCreate description(final String description) {
  ...
  public ExtendedPropertyKeyCreate spaceId(final UUID spaceId) {
  ...
  public ExtendedPropertyKeyCreate scope(final ScopeEnum scope) {
    this.scope = scope;
    return this;
  }
  ...
  public ExtendedPropertyKeyCreate validationData(final String validationData) {
  ...
  public ExtendedPropertyKeyCreate min(final String min) {
    this.min = min;
    return this;
  }
  ...
  public ExtendedPropertyKeyCreate max(final String max) {
    this.max = max;
    return this;
  }
