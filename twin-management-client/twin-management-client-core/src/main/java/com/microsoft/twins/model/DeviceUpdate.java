...
public class DeviceUpdate {
  ...
  public DeviceUpdate name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public DeviceUpdate friendlyName(final String friendlyName) {
  ...
  public DeviceUpdate description(final String description) {
  ...
  public DeviceUpdate hardwareId(final String hardwareId) {
  ...
  public DeviceUpdate spaceId(final UUID spaceId) {
  ...
  public DeviceUpdate location(final Location location) {
  ...
  public DeviceUpdate type(final String type) {
    this.type = type;
    return this;
  }
  ...
  public DeviceUpdate typeId(final Integer typeId) {
    this.typeId = typeId;
    return this;
  }
  ...
  public DeviceUpdate subtype(final String subtype) {
  ...
  public DeviceUpdate subtypeId(final Integer subtypeId) {
