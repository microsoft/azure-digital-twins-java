...
public class UserDefinedFunctionUpdate {
  ...
  private List<UUID> matchers;

  public UserDefinedFunctionUpdate spaceId(final UUID spaceId) {
  ...
  public UserDefinedFunctionUpdate name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public UserDefinedFunctionUpdate friendlyName(final String friendlyName) {
  ...
  public UserDefinedFunctionUpdate description(final String description) {
  ...
  public UserDefinedFunctionUpdate disabled(final Boolean disabled) {
  ...
  public UserDefinedFunctionUpdate matchers(final List<UUID> matchers) {
    this.matchers = matchers;
    return this;
  }

  public UserDefinedFunctionUpdate addMatchersItem(final UUID matchersItem) {
   ...
   **/
  @Valid
  public List<UUID> getMatchers() {
    return matchers;
  }

  public void setMatchers(final List<UUID> matchers) {
    this.matchers = matchers;
  }
}
