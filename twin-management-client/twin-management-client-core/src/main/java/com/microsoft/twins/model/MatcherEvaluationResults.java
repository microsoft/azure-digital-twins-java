...
public class MatcherEvaluationResults {
  ...
  public MatcherEvaluationResults success(final Boolean success) {
  ...
  public MatcherEvaluationResults logs(final List<String> logs) {
    this.logs = logs;
    return this;
  }

  public MatcherEvaluationResults addLogsItem(final String logsItem) {
    if (this.logs == null) {
