...
@ToString
@EqualsAndHashCode
public class ConditionRetrieve extends AbstractRetrieve<ConditionRetrieve> {
  ...
  public ConditionRetrieve target(final TargetEnum target) {
    this.target = target;
    return this;
  }
  ...
  public ConditionRetrieve path(final String path) {
    this.path = path;
    return this;
  }
  ...
  public ConditionRetrieve value(final String value) {
    this.value = value;
    return this;
  }
  ...
  public ConditionRetrieve comparison(final ComparisonEnum comparison) {
