...
public class DeviceCreate {
  ...
  private List<SensorCreateNoParent> sensors;
  ...
  public DeviceCreate sensors(final List<SensorCreateNoParent> sensors) {
   ...
   **/
  @Valid
  public List<SensorCreateNoParent> getSensors() {
    return sensors;
  }

  public void setSensors(final List<SensorCreateNoParent> sensors) {
    this.sensors = sensors;
  }
  ...
  public DeviceCreate properties(final List<ExtendedPropertyCreate> properties) {
   ...
   **/
  @Valid
  public List<ExtendedPropertyCreate> getProperties() {
    return properties;
  }

  public void setProperties(final List<ExtendedPropertyCreate> properties) {
    this.properties = properties;
  }
}
