...
public class EndpointRetrieve extends AbstractRetrieve<EndpointRetrieve> {
  ...
  public EndpointRetrieve lastUpdatedUtc(final LocalDateTime lastUpdatedUtc) {
  ...
  public EndpointRetrieve status(final StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public EndpointRetrieve type(final TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public EndpointRetrieve eventTypes(final List<EventTypesEnum> eventTypes) {
    this.eventTypes = eventTypes;
    return this;
  }

  public EndpointRetrieve addEventTypesItem(final EventTypesEnum eventTypesItem) {
  ...
  public void setEventTypes(final List<EventTypesEnum> eventTypes) {
    this.eventTypes = eventTypes;
  }

  public EndpointRetrieve connectionString(final String connectionString) {
  ...
  public EndpointRetrieve secondaryConnectionString(final String secondaryConnectionString) {
  ...
  public EndpointRetrieve path(final String path) {
    this.path = path;
    return this;
  }
  ...
  public EndpointRetrieve properties(final Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public EndpointRetrieve putPropertiesItem(final String key, final String propertiesItem) {
