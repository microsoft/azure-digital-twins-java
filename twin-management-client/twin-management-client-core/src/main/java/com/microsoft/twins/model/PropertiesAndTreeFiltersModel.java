...
public class PropertiesAndTreeFiltersModel {
  ...
  public enum PropertyValueSearchTypeEnum {
    ...
    PropertyValueSearchTypeEnum(final String value) {
      this.value = value;
    }
  ...
  public enum TraverseEnum {
    ...
    TraverseEnum(final String value) {
      this.value = value;
    }
  ...
  public PropertiesAndTreeFiltersModel propertyKey(final String propertyKey) {
  ...
  public PropertiesAndTreeFiltersModel propertyValue(final String propertyValue) {
  ...
  public PropertiesAndTreeFiltersModel spaceId(final UUID spaceId) {
  ...
  public PropertiesAndTreeFiltersModel traverse(final TraverseEnum traverse) {
  ...
  public void setTraverse(final TraverseEnum traverse) {
    this.traverse = traverse;
  }

  public PropertiesAndTreeFiltersModel minLevel(final Integer minLevel) {
  ...
  public PropertiesAndTreeFiltersModel maxLevel(final Integer maxLevel) {
  ...
  public PropertiesAndTreeFiltersModel minRelative(final Boolean minRelative) {
  ...
  public void setMinRelative(final Boolean minRelative) {
    this.minRelative = minRelative;
  }

  public PropertiesAndTreeFiltersModel maxRelative(final Boolean maxRelative) {
  ...
  public void setMaxRelative(final Boolean maxRelative) {
    this.maxRelative = maxRelative;
  }
}
