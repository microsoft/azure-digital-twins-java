...
public class SelectExpandQueryOption {
  ...
  private SelectExpandQueryValidator validator;
  @JsonProperty("selectExpandClause")
  private SelectExpandClause selectExpandClause;

  public SelectExpandQueryOption context(final ODataQueryContext context) {
  ...
  public SelectExpandQueryOption validator(final SelectExpandQueryValidator validator) {
   ...
   **/
  @Valid
  public SelectExpandQueryValidator getValidator() {
    return validator;
  }

  public void setValidator(final SelectExpandQueryValidator validator) {
    this.validator = validator;
  }

  public SelectExpandQueryOption selectExpandClause(final SelectExpandClause selectExpandClause) {
  ...
  public void setSelectExpandClause(final SelectExpandClause selectExpandClause) {
    this.selectExpandClause = selectExpandClause;
  }
}
