...
public class ExtendedTypeCreate {
  ...
  public ExtendedTypeCreate category(final CategoryEnum category) {
  ...
  public ExtendedTypeCreate spaceId(final UUID spaceId) {
  ...
  public ExtendedTypeCreate name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public ExtendedTypeCreate friendlyName(final String friendlyName) {
  ...
  public ExtendedTypeCreate description(final String description) {
  ...
  public ExtendedTypeCreate disabled(final Boolean disabled) {
  ...
  public ExtendedTypeCreate logicalOrder(final Integer logicalOrder) {
