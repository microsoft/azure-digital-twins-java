...
public class ODataQueryOptionsDevice {
  ...
  public ODataQueryOptionsDevice context(final ODataQueryContext context) {
  ...
  public ODataQueryOptionsDevice rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsDevice selectExpand(final SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsDevice filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsDevice orderBy(final OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsDevice skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsDevice top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsDevice inlineCount(final InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsDevice validator(final ODataQueryValidator validator) {
