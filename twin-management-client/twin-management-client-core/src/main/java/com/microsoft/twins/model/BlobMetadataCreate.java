...
public class BlobMetadataCreate {
  ...
  public BlobMetadataCreate name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public BlobMetadataCreate parentId(final UUID parentId) {
  ...
  public BlobMetadataCreate type(final String type) {
    this.type = type;
    return this;
  }
  ...
  public BlobMetadataCreate subtype(final String subtype) {
  ...
  public BlobMetadataCreate typeId(final Integer typeId) {
    this.typeId = typeId;
    return this;
  }
  ...
  public BlobMetadataCreate subtypeId(final Integer subtypeId) {
  ...
  public BlobMetadataCreate sharing(final SharingEnum sharing) {
  ...
  public BlobMetadataCreate description(final String description) {
