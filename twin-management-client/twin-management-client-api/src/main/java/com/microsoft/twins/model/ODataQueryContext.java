...
public class ODataQueryContext {
  ...
  public ODataQueryContext model(final IEdmModel model) {
    this.model = model;
    return this;
  }
  ...
  public void setModel(final IEdmModel model) {
    this.model = model;
  }

  public ODataQueryContext elementType(final IEdmType elementType) {
  ...
  public void setElementType(final IEdmType elementType) {
    this.elementType = elementType;
  }
