...
public class KeyStoreRetrieve extends AbstractRetrieve<KeyStoreRetrieve> {
  ...
  @JsonProperty("keys")
  private List<SecurityKeyRetrieve> keys;
  @JsonProperty("space")
  private SpaceRetrieve space;

  public KeyStoreRetrieve name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public KeyStoreRetrieve description(final String description) {
  ...
  public KeyStoreRetrieve spaceId(final UUID spaceId) {
  ...
  public KeyStoreRetrieve fullName(final String fullName) {
  ...
  public KeyStoreRetrieve spacePaths(final List<String> spacePaths) {
    this.spacePaths = spacePaths;
    return this;
  }

  public KeyStoreRetrieve addSpacePathsItem(final String spacePathsItem) {
  ...
  public KeyStoreRetrieve keys(final List<SecurityKeyRetrieve> keys) {
    this.keys = keys;
    return this;
  }

  public KeyStoreRetrieve addKeysItem(final SecurityKeyRetrieve keysItem) {
    if (this.keys == null) {
   ...
   **/
  @Valid
  public List<SecurityKeyRetrieve> getKeys() {
    return keys;
  }

  public void setKeys(final List<SecurityKeyRetrieve> keys) {
    this.keys = keys;
  }

  public KeyStoreRetrieve space(final SpaceRetrieve space) {
    this.space = space;
    return this;
  }
