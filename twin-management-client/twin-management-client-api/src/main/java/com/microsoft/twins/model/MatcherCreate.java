...
public class MatcherCreate {
  ...
  public MatcherCreate name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public MatcherCreate description(final String description) {
  ...
  public MatcherCreate friendlyName(final String friendlyName) {
  ...
  public MatcherCreate conditions(final List<ConditionCreate> conditions) {
    this.conditions = conditions;
    return this;
  }

  public MatcherCreate addConditionsItem(final ConditionCreate conditionsItem) {
   ...
   **/
  @Valid
  public List<ConditionCreate> getConditions() {
    return conditions;
  }

  public void setConditions(final List<ConditionCreate> conditions) {
    this.conditions = conditions;
  }

  public MatcherCreate spaceId(final UUID spaceId) {
