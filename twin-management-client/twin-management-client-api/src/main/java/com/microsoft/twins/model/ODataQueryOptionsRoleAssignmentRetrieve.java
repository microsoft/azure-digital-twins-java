...
public class ODataQueryOptionsRoleAssignmentRetrieve {
  ...
  public ODataQueryOptionsRoleAssignmentRetrieve context(final ODataQueryContext context) {
  ...
  public ODataQueryOptionsRoleAssignmentRetrieve rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsRoleAssignmentRetrieve filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsRoleAssignmentRetrieve orderBy(final OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsRoleAssignmentRetrieve skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsRoleAssignmentRetrieve top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsRoleAssignmentRetrieve validator(final ODataQueryValidator validator) {
