...
public class UserDefinedFunctionCreate {
  ...
  public UserDefinedFunctionCreate spaceId(final UUID spaceId) {
  ...
  public UserDefinedFunctionCreate name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public UserDefinedFunctionCreate friendlyName(final String friendlyName) {
  ...
  public UserDefinedFunctionCreate description(final String description) {
  ...
  public UserDefinedFunctionCreate disabled(final Boolean disabled) {
  ...
  public UserDefinedFunctionCreate matchers(final List<UUID> matchers) {
    this.matchers = matchers;
    return this;
  }

  public UserDefinedFunctionCreate addMatchersItem(final UUID matchersItem) {
