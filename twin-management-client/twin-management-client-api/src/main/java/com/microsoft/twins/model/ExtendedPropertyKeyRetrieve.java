...
public class ExtendedPropertyKeyRetrieve {
  ...
  public ExtendedPropertyKeyRetrieve id(final Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ExtendedPropertyKeyRetrieve name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public ExtendedPropertyKeyRetrieve category(final String category) {
  ...
  public ExtendedPropertyKeyRetrieve description(final String description) {
  ...
  public ExtendedPropertyKeyRetrieve spaceId(final UUID spaceId) {
  ...
  public ExtendedPropertyKeyRetrieve scope(final ScopeEnum scope) {
    this.scope = scope;
    return this;
  }
  ...
  public ExtendedPropertyKeyRetrieve fullName(final String fullName) {
  ...
  public ExtendedPropertyKeyRetrieve spacePaths(final List<String> spacePaths) {
    this.spacePaths = spacePaths;
    return this;
  }

  public ExtendedPropertyKeyRetrieve addSpacePathsItem(final String spacePathsItem) {
  ...
  public ExtendedPropertyKeyRetrieve space(final SpaceRetrieve space) {
    this.space = space;
    return this;
  }
  ...
  public void setPrimitiveDataType(final PrimitiveDataTypeEnum primitiveDataType) {
    this.primitiveDataType = primitiveDataType;
  }

  public ExtendedPropertyKeyRetrieve validationData(final String validationData) {
  ...
  public void setValidationData(final String validationData) {
    this.validationData = validationData;
  }

  public ExtendedPropertyKeyRetrieve min(final String min) {
    this.min = min;
    return this;
  }
  ...
  public ExtendedPropertyKeyRetrieve max(final String max) {
    this.max = max;
    return this;
  }
