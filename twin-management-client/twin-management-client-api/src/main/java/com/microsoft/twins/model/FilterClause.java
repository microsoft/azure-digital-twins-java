...
public class FilterClause {
  ...
  public FilterClause expression(final SingleValueNode expression) {
  ...
  public FilterClause rangeVariable(final RangeVariable rangeVariable) {
  ...
  public FilterClause itemType(final IEdmTypeReference itemType) {
