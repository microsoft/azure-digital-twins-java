...
public class ODataQueryOptionsSpace {
  ...
  public ODataQueryOptionsSpace context(final ODataQueryContext context) {
  ...
  public ODataQueryOptionsSpace rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsSpace selectExpand(final SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsSpace filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsSpace orderBy(final OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsSpace skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsSpace top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsSpace inlineCount(final InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsSpace validator(final ODataQueryValidator validator) {
