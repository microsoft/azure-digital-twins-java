...
public class ExtendedTypeUpdate {
  ...
  public ExtendedTypeUpdate spaceId(final UUID spaceId) {
  ...
  public ExtendedTypeUpdate name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public ExtendedTypeUpdate friendlyName(final String friendlyName) {
  ...
  public ExtendedTypeUpdate description(final String description) {
  ...
  public ExtendedTypeUpdate disabled(final Boolean disabled) {
  ...
  public ExtendedTypeUpdate logicalOrder(final Integer logicalOrder) {
