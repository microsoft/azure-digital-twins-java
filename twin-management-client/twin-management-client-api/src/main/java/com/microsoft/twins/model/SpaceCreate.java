...
public class SpaceCreate extends SpaceUpdate {
  ...
  private List<SpaceCreate> children;
  @JsonProperty("users")
  ...
  public SpaceCreate children(final List<SpaceCreate> children) {
   ...
   **/
  @Valid
  public List<SpaceCreate> getChildren() {
    return children;
  }

  public void setChildren(final List<SpaceCreate> children) {
    this.children = children;
  }

  public SpaceCreate users(final List<UserCreate> users) {
    this.users = users;
    return this;
  }
  ...
  public void setUsers(final List<UserCreate> users) {
    this.users = users;
  }
}
