...
public class BlobMetadataUpdate {
  ...
  public BlobMetadataUpdate name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public BlobMetadataUpdate sharing(final SharingEnum sharing) {
  ...
  public BlobMetadataUpdate description(final String description) {
  ...
  public BlobMetadataUpdate deleteOlderVersions(final Boolean deleteOlderVersions) {
  ...
  public void setDeleteOlderVersions(final Boolean deleteOlderVersions) {
    this.deleteOlderVersions = deleteOlderVersions;
  }
}
