...
public class ODataQueryOptionsOntology {
  ...
  public ODataQueryOptionsOntology context(final ODataQueryContext context) {
  ...
  public ODataQueryOptionsOntology rawValues(final ODataRawQueryOptions rawValues) {
  ...
  public ODataQueryOptionsOntology selectExpand(final SelectExpandQueryOption selectExpand) {
  ...
  public ODataQueryOptionsOntology filter(final FilterQueryOption filter) {
    this.filter = filter;
    return this;
  }
  ...
  public ODataQueryOptionsOntology orderBy(final OrderByQueryOption orderBy) {
  ...
  public ODataQueryOptionsOntology skip(final SkipQueryOption skip) {
    this.skip = skip;
    return this;
  }
  ...
  public ODataQueryOptionsOntology top(final TopQueryOption top) {
    this.top = top;
    return this;
  }
  ...
  public ODataQueryOptionsOntology inlineCount(final InlineCountQueryOption inlineCount) {
  ...
  public ODataQueryOptionsOntology validator(final ODataQueryValidator validator) {
