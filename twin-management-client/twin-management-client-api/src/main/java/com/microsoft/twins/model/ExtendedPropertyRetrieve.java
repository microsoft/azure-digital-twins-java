...
public class ExtendedPropertyRetrieve {
  ...
  public ExtendedPropertyRetrieve name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public ExtendedPropertyRetrieve value(final String value) {
    this.value = value;
    return this;
  }
  ...
  public ExtendedPropertyRetrieve dataType(final String dataType) {
