...
public class IEdmVocabularyAnnotation {
  ...
  public IEdmVocabularyAnnotation term(final IEdmTerm term) {
    this.term = term;
    return this;
  }
  ...
  public void setTerm(final IEdmTerm term) {
    this.term = term;
  }

  public IEdmVocabularyAnnotation target(final IEdmVocabularyAnnotatable target) {
    this.target = target;
    return this;
  }
  ...
  public void setTarget(final IEdmVocabularyAnnotatable target) {
    this.target = target;
  }
}
