...
public interface ResourcesApi extends TwinsApiClient.Api {
  ...
  UUID resourcesCreate(@Param("spaceId") UUID spaceId, @Param("type") String type,
      ...
      @Param("parameters") java.util.Map<String, String> parameters,
      @Param("resourceDependencies") java.util.List<UUID> resourceDependencies,
  ...
  @Headers({"Accept: */*",})
  java.util.List<SpaceResourceRetrieve> resourcesRetrieve(@Param("type") String type,
  ...
  java.util.List<SpaceResourceRetrieve> resourcesRetrieve(
  ...
  void resourcesUpdate(@Param("id") String id, @Param("spaceId") UUID spaceId,
      @Param("size") String size, @Param("parameters") java.util.Map<String, String> parameters,
      @Param("status") String status);
}
