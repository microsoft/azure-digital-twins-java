...
public interface EndpointsApi extends TwinsApiClient.Api {
  ...
  @RequestLine("POST /api/v1.0/endpoints")
  @Headers({"Accept: */*",})
  UUID endpointsCreate(@Param("type") String type,
  ...
  @Headers({"Accept: */*",})
  java.util.List<EndpointRetrieve> endpointsRetrieve(@Param("timeUpdated") String timeUpdated,
  ...
  java.util.List<EndpointRetrieve> endpointsRetrieve(
