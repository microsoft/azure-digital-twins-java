...
public interface SpacesApi extends TwinsApiClient.Api {
  ...
  UUID spacesCreate(@Param("name") String name, @Param("description") String description,
      ...
      @Param("timeZoneName") String timeZoneName,
      @Param("children") java.util.List<SpaceCreate> children,
      @Param("users") java.util.List<UserCreate> users);
  ...
  @Headers({"Accept: */*",})
  java.util.List<SensorValue> spacesGetValue(@Param("id") String id,
  ...
  @Headers({"Accept: */*",})
  Object spacesMoveUsersToSpace(java.util.List<UserCreate> body,
      @Param("toSpaceId") String toSpaceId, @Param("id") String id,
  ...
  @RequestLine("POST /api/v1.0/spaces/{id}/users/move?toSpaceId={toSpaceId}&resetLocation={resetLocation}")
  @Headers({"Content-Type: */*",})
  Object spacesMoveUsersToSpace(java.util.List<UserCreate> body, @Param("id") String id,
      @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  @Headers({"Accept: */*",})
  java.util.List<SpaceRetrieveWithChildren> spacesRetrieve(@Param("ids") String ids,
  ...
  @RequestLine("GET /api/v1.0/spaces?ids={ids}&name={name}&types={types}&subtypes={subtypes}&statuses={statuses}&useParentSpace={useParentSpace}&userUpn={userUpn}&sensorDataTypes={sensorDataTypes}&includes={includes}&propertyKey={propertyKey}&propertyValue={propertyValue}&propertyValueSearchType={propertyValueSearchType}&spaceId={spaceId}&traverse={traverse}&minLevel={minLevel}&maxLevel={maxLevel}&minRelative={minRelative}&maxRelative={maxRelative}")
  @Headers({"Content-Type: */*",})
  java.util.List<SpaceRetrieveWithChildren> spacesRetrieve(
      @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  @Headers({"Accept: */*",})
  java.util.List<BlobMetadataRetrieve> spacesRetrieveBlobMetadata(@Param("names") String names,
  ...
  @RequestLine("GET /api/v1.0/spaces/blobs?names={names}&ids={ids}&sharings={sharings}&types={types}&subtypes={subtypes}&includes={includes}&spaceId={spaceId}&traverse={traverse}&minLevel={minLevel}&maxLevel={maxLevel}&minRelative={minRelative}&maxRelative={maxRelative}")
  @Headers({"Content-Type: */*",})
  java.util.List<BlobMetadataRetrieve> spacesRetrieveBlobMetadata(
      @QueryMap(encoded = true) Map<String, Object> queryParams);
  ...
  public static class SpacesRetrieveBlobMetadataQueryParams extends HashMap<String, Object> {
    ...
    public SpacesRetrieveBlobMetadataQueryParams ids(final String value) {
      put("ids", EncodingUtils.encode(value));
      return this;
    }
  ...
  @Headers({"Accept: */*",})
  java.util.List<UserRetrieve> spacesRetrieveUsers(@Param("id") String id,
      @Param("traverse") String traverse, @Param("unmapped") Boolean unmapped,
  ...
  @Headers({"Accept: */*",})
  Object spacesUpdateProperties(java.util.List<ExtendedPropertyCreate> body,
      @Param("id") String id);
}
