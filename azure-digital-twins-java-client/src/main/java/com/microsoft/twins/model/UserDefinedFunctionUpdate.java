...
public class UserDefinedFunctionUpdate {
  ...
  private java.util.List<UUID> matchers;

  public UserDefinedFunctionUpdate spaceId(UUID spaceId) {
  ...
  public UserDefinedFunctionUpdate name(String name) {
    this.name = name;
    return this;
  }

  /**
   * Name must be unique for the given space hierarchy. Can only contain alphanumeric or underscore
   * characters.
   *
   * @return name
   **/
  ...
  public UserDefinedFunctionUpdate friendlyName(String friendlyName) {
  ...
  public UserDefinedFunctionUpdate description(String description) {
  ...
  public UserDefinedFunctionUpdate disabled(Boolean disabled) {
  ...
  public UserDefinedFunctionUpdate matchers(java.util.List<UUID> matchers) {
    this.matchers = matchers;
    return this;
  }

  public UserDefinedFunctionUpdate addMatchersItem(UUID matchersItem) {
   ...
   **/
  @Valid
  public java.util.List<UUID> getMatchers() {
    return matchers;
  }

  public void setMatchers(java.util.List<UUID> matchers) {
    this.matchers = matchers;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final UserDefinedFunctionUpdate userDefinedFunctionUpdate = (UserDefinedFunctionUpdate) o;
    return Objects.equals(this.spaceId, userDefinedFunctionUpdate.spaceId)
        && Objects.equals(this.name, userDefinedFunctionUpdate.name)
        && Objects.equals(this.friendlyName, userDefinedFunctionUpdate.friendlyName)
        && Objects.equals(this.description, userDefinedFunctionUpdate.description)
        && Objects.equals(this.disabled, userDefinedFunctionUpdate.disabled)
        && Objects.equals(this.matchers, userDefinedFunctionUpdate.matchers);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(spaceId, name, friendlyName, description, disabled, matchers);
  }

  @Override
  public String toString() {
    final StringBuilder sb = new StringBuilder();
    sb.append("class UserDefinedFunctionUpdate {\n");
