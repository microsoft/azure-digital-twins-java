 ...
 */
public class ExtendedPropertyKeyRetrieve {
  @JsonProperty("id")
  private Integer id;
  @JsonProperty("name")
  private String name;
  ...
  public enum PrimitiveDataTypeEnum {
    ...
    PrimitiveDataTypeEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static PrimitiveDataTypeEnum fromValue(String text) {
  ...
  private PrimitiveDataTypeEnum primitiveDataType;
  ...
  public ExtendedPropertyKeyRetrieve id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public ExtendedPropertyKeyRetrieve name(String name) {
    this.name = name;
    return this;
  }
  ...
  public ExtendedPropertyKeyRetrieve category(String category) {
    this.category = category;
    return this;
  }

  /**
   * Category. Used for permissioning and filtering
   *
   * @return category
   **/
  @NotNull
  ...
  public ExtendedPropertyKeyRetrieve description(String description) {
  ...
  public ExtendedPropertyKeyRetrieve spaceId(UUID spaceId) {
  ...
  public ExtendedPropertyKeyRetrieve scope(ScopeEnum scope) {
    this.scope = scope;
    return this;
  }
  ...
  public ExtendedPropertyKeyRetrieve fullName(String fullName) {
  ...
  public ExtendedPropertyKeyRetrieve spacePaths(java.util.List<String> spacePaths) {
    this.spacePaths = spacePaths;
    return this;
  }

  public ExtendedPropertyKeyRetrieve addSpacePathsItem(String spacePathsItem) {
  ...
  public ExtendedPropertyKeyRetrieve space(SpaceRetrieve space) {
    this.space = space;
    return this;
  }
  ...
  public ExtendedPropertyKeyRetrieve primitiveDataType(PrimitiveDataTypeEnum primitiveDataType) {
   ...
   **/
  public PrimitiveDataTypeEnum getPrimitiveDataType() {
    return primitiveDataType;
  }

  public void setPrimitiveDataType(PrimitiveDataTypeEnum primitiveDataType) {
    this.primitiveDataType = primitiveDataType;
  }

  public ExtendedPropertyKeyRetrieve validationData(String validationData) {
    this.validationData = validationData;
    return this;
  }

  /**
   * Optional field used to validate property values. - For string: an optional regular expression -
   * For enum or set: a &#x27;;&#x27; delimited list of possible alphanumeric values - For JSON: an
  ...
  public ExtendedPropertyKeyRetrieve min(String min) {
    this.min = min;
    return this;
  }

  /**
   * Optional field used to limit the range of property values. - For value types (int, long,
   * datetime) the boundary value. - For string and JSON the number of characters. - For Set the
   * number of elements.
   *
   * @return min
   **/
  ...
  public ExtendedPropertyKeyRetrieve max(String max) {
    this.max = max;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final ExtendedPropertyKeyRetrieve extendedPropertyKeyRetrieve = (ExtendedPropertyKeyRetrieve) o;
    return Objects.equals(this.id, extendedPropertyKeyRetrieve.id)
        && Objects.equals(this.name, extendedPropertyKeyRetrieve.name)
        && Objects.equals(this.category, extendedPropertyKeyRetrieve.category)
        && Objects.equals(this.description, extendedPropertyKeyRetrieve.description)
        && Objects.equals(this.spaceId, extendedPropertyKeyRetrieve.spaceId)
        && Objects.equals(this.scope, extendedPropertyKeyRetrieve.scope)
        && Objects.equals(this.fullName, extendedPropertyKeyRetrieve.fullName)
        && Objects.equals(this.spacePaths, extendedPropertyKeyRetrieve.spacePaths)
        && Objects.equals(this.space, extendedPropertyKeyRetrieve.space)
        && Objects.equals(this.primitiveDataType, extendedPropertyKeyRetrieve.primitiveDataType)
        && Objects.equals(this.validationData, extendedPropertyKeyRetrieve.validationData)
        && Objects.equals(this.min, extendedPropertyKeyRetrieve.min)
        && Objects.equals(this.max, extendedPropertyKeyRetrieve.max);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, name, category, description, spaceId, scope, fullName,
        spacePaths, space, primitiveDataType, validationData, min, max);
  }

  @Override
  public String toString() {
    final StringBuilder sb = new StringBuilder();
    sb.append("class ExtendedPropertyKeyRetrieve {\n");
    ...
    sb.append("    primitiveDataType: ").append(toIndentedString(primitiveDataType)).append("\n");
