 ...
 */
public class SensorCreateNoParent {
  @JsonProperty("port")
  private String port;
  ...
  public SensorCreateNoParent port(String port) {
    this.port = port;
    return this;
  }
  ...
  public SensorCreateNoParent pollRate(Integer pollRate) {
  ...
  public SensorCreateNoParent dataType(String dataType) {
  ...
  public SensorCreateNoParent type(String type) {
    this.type = type;
    return this;
  }
  ...
  public SensorCreateNoParent portType(String portType) {
  ...
  public SensorCreateNoParent dataUnitType(String dataUnitType) {
  ...
  public SensorCreateNoParent dataSubtype(String dataSubtype) {
  ...
  public SensorCreateNoParent spaceId(UUID spaceId) {
    this.spaceId = spaceId;
    return this;
  }

  /**
   * Parent space Id. If not specified, the device&#x27;s parent space is used
   *
   * @return spaceId
   **/
  @Valid
  ...
  public SensorCreateNoParent location(Location location) {
  ...
  public SensorCreateNoParent portTypeId(Integer portTypeId) {
    this.portTypeId = portTypeId;
    return this;
  }

  /**
   * Port type identifier. Cannot specify both PortType and PortTypeId
   *
   * @return portTypeId
   **/
  ...
  public SensorCreateNoParent dataUnitTypeId(Integer dataUnitTypeId) {
    this.dataUnitTypeId = dataUnitTypeId;
    return this;
  }

  /**
   * Data type unit identifier. Cannot specify both DataUnitType and DataUnitTypeId
   *
  ...
  public SensorCreateNoParent typeId(Integer typeId) {
    this.typeId = typeId;
    return this;
  }
  ...
  public SensorCreateNoParent dataTypeId(Integer dataTypeId) {
    this.dataTypeId = dataTypeId;
    return this;
  }

  /**
   * Data type identifier. Cannot specify both DataType and DataTypeId
   *
   * @return dataTypeId
   **/
  ...
  public SensorCreateNoParent dataSubtypeId(Integer dataSubtypeId) {
    this.dataSubtypeId = dataSubtypeId;
    return this;
  }

  /**
   * Data subtype identifier. Cannot specify both DataSubtype and DataSubtypeId
   *
  ...
  public SensorCreateNoParent hardwareId(String hardwareId) {
    this.hardwareId = hardwareId;
    return this;
  }

  /**
   * Hardware unique identifier, such as MAC address. If left unspecified, set to a random Guid
   * string.
   *
   * @return hardwareId
   **/
  ...
  public SensorCreateNoParent properties(java.util.List<ExtendedPropertyCreate> properties) {
    this.properties = properties;
    return this;
  }

  public SensorCreateNoParent addPropertiesItem(ExtendedPropertyCreate propertiesItem) {
  ...
  public void setProperties(java.util.List<ExtendedPropertyCreate> properties) {
    this.properties = properties;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final SensorCreateNoParent sensorCreateNoParent = (SensorCreateNoParent) o;
    return Objects.equals(this.port, sensorCreateNoParent.port)
        && Objects.equals(this.pollRate, sensorCreateNoParent.pollRate)
        && Objects.equals(this.dataType, sensorCreateNoParent.dataType)
        && Objects.equals(this.type, sensorCreateNoParent.type)
        && Objects.equals(this.portType, sensorCreateNoParent.portType)
        && Objects.equals(this.dataUnitType, sensorCreateNoParent.dataUnitType)
        && Objects.equals(this.dataSubtype, sensorCreateNoParent.dataSubtype)
        && Objects.equals(this.spaceId, sensorCreateNoParent.spaceId)
        && Objects.equals(this.location, sensorCreateNoParent.location)
        && Objects.equals(this.portTypeId, sensorCreateNoParent.portTypeId)
        && Objects.equals(this.dataUnitTypeId, sensorCreateNoParent.dataUnitTypeId)
        && Objects.equals(this.typeId, sensorCreateNoParent.typeId)
        && Objects.equals(this.dataTypeId, sensorCreateNoParent.dataTypeId)
        && Objects.equals(this.dataSubtypeId, sensorCreateNoParent.dataSubtypeId)
        && Objects.equals(this.hardwareId, sensorCreateNoParent.hardwareId)
        && Objects.equals(this.properties, sensorCreateNoParent.properties);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(port, pollRate, dataType, type, portType, dataUnitType,
        dataSubtype, spaceId, location, portTypeId, dataUnitTypeId, typeId, dataTypeId,
        dataSubtypeId, hardwareId, properties);
  }

  @Override
  public String toString() {
    final StringBuilder sb = new StringBuilder();
    sb.append("class SensorCreateNoParent {\n");
