 ...
 */
public class ExtendedPropertyFilters {
  ...
  public ExtendedPropertyFilters propertyKey(String propertyKey) {
  ...
  public ExtendedPropertyFilters propertyValue(String propertyValue) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final ExtendedPropertyFilters extendedPropertyFilters = (ExtendedPropertyFilters) o;
    return Objects.equals(this.propertyKey, extendedPropertyFilters.propertyKey)
        && Objects.equals(this.propertyValue, extendedPropertyFilters.propertyValue) && Objects
            .equals(this.propertyValueSearchType, extendedPropertyFilters.propertyValueSearchType);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(propertyKey, propertyValue, propertyValueSearchType);
  }

  @Override
  public String toString() {
    final StringBuilder sb = new StringBuilder();
    sb.append("class ExtendedPropertyFilters {\n");
