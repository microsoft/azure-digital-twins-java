...
public class SpaceResourceCreate {
  ...
  private java.util.List<UUID> resourceDependencies;
  ...
  public SpaceResourceCreate spaceId(UUID spaceId) {
  ...
  public SpaceResourceCreate type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public SpaceResourceCreate size(SizeEnum size) {
    this.size = size;
    return this;
  }
  ...
  public SpaceResourceCreate region(RegionEnum region) {
    this.region = region;
    return this;
  }
  ...
  public SpaceResourceCreate isExternallyCreated(Boolean isExternallyCreated) {
  ...
  public SpaceResourceCreate parameters(java.util.Map<String, String> parameters) {
    this.parameters = parameters;
    return this;
  }

  public SpaceResourceCreate putParametersItem(String key, String parametersItem) {
  ...
  public SpaceResourceCreate resourceDependencies(java.util.List<UUID> resourceDependencies) {
    this.resourceDependencies = resourceDependencies;
    return this;
  }

  public SpaceResourceCreate addResourceDependenciesItem(UUID resourceDependenciesItem) {
   ...
   **/
  @Valid
  public java.util.List<UUID> getResourceDependencies() {
    return resourceDependencies;
  }

  public void setResourceDependencies(java.util.List<UUID> resourceDependencies) {
    this.resourceDependencies = resourceDependencies;
  }

  public SpaceResourceCreate status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final SpaceResourceCreate spaceResourceCreate = (SpaceResourceCreate) o;
    return Objects.equals(this.spaceId, spaceResourceCreate.spaceId)
        && Objects.equals(this.type, spaceResourceCreate.type)
        && Objects.equals(this.size, spaceResourceCreate.size)
        && Objects.equals(this.region, spaceResourceCreate.region)
        && Objects.equals(this.isExternallyCreated, spaceResourceCreate.isExternallyCreated)
        && Objects.equals(this.parameters, spaceResourceCreate.parameters)
        && Objects.equals(this.resourceDependencies, spaceResourceCreate.resourceDependencies)
        && Objects.equals(this.status, spaceResourceCreate.status);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(spaceId, type, size, region, isExternallyCreated, parameters,
        resourceDependencies, status);
  }

  @Override
  public String toString() {
    final StringBuilder sb = new StringBuilder();
    sb.append("class SpaceResourceCreate {\n");
    ...
    sb.append("    resourceDependencies: ").append(toIndentedString(resourceDependencies))
        .append("\n");
