 ...
 */
public class SecurityKeyUpdate {
  /**
   * Key status
   */
  ...
  public SecurityKeyUpdate status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final SecurityKeyUpdate securityKeyUpdate = (SecurityKeyUpdate) o;
    return Objects.equals(this.status, securityKeyUpdate.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class SecurityKeyUpdate {\n");
