 ...
 */
public class ExtendedPropertyCreate {
  @JsonProperty("name")
  private String name;
  @JsonProperty("value")
  private String value;

  public ExtendedPropertyCreate name(String name) {
    this.name = name;
    return this;
  }

  /**
   * The name of an already defined property key
   *
   * @return name
   **/
  @NotNull
  ...
  public ExtendedPropertyCreate value(String value) {
    this.value = value;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final ExtendedPropertyCreate extendedPropertyCreate = (ExtendedPropertyCreate) o;
    return Objects.equals(this.name, extendedPropertyCreate.name)
        && Objects.equals(this.value, extendedPropertyCreate.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExtendedPropertyCreate {\n");
