...
public class DeviceUpdate {
  ...
  public DeviceUpdate friendlyName(String friendlyName) {
  ...
  public DeviceUpdate description(String description) {
  ...
  public DeviceUpdate hardwareId(String hardwareId) {
  ...
  public DeviceUpdate gatewayId(String gatewayId) {
  ...
  public DeviceUpdate spaceId(UUID spaceId) {
  ...
  public DeviceUpdate status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public DeviceUpdate location(Location location) {
  ...
  public DeviceUpdate typeId(Integer typeId) {
    this.typeId = typeId;
    return this;
  }
  ...
  public DeviceUpdate subtypeId(Integer subtypeId) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final DeviceUpdate deviceUpdate = (DeviceUpdate) o;
    return Objects.equals(this.name, deviceUpdate.name)
        && Objects.equals(this.friendlyName, deviceUpdate.friendlyName)
        && Objects.equals(this.description, deviceUpdate.description)
        && Objects.equals(this.hardwareId, deviceUpdate.hardwareId)
        && Objects.equals(this.gatewayId, deviceUpdate.gatewayId)
        && Objects.equals(this.spaceId, deviceUpdate.spaceId)
        && Objects.equals(this.status, deviceUpdate.status)
        && Objects.equals(this.location, deviceUpdate.location)
        && Objects.equals(this.type, deviceUpdate.type)
        && Objects.equals(this.typeId, deviceUpdate.typeId)
        && Objects.equals(this.subtype, deviceUpdate.subtype)
        && Objects.equals(this.subtypeId, deviceUpdate.subtypeId);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(name, friendlyName, description, hardwareId, gatewayId, spaceId,
        status, location, type, typeId, subtype, subtypeId);
  }
