 ...
 */
public class ExtendedPropertyKeyCreate {
  @JsonProperty("name")
  private String name;
  ...
  public ExtendedPropertyKeyCreate name(String name) {
    this.name = name;
    return this;
  }

  /**
   * Key name. Must be unique for a given space. Can only contain alphanumeric or underscore
   * characters
   *
   * @return name
   **/
  ...
  public ExtendedPropertyKeyCreate primitiveDataType(PrimitiveDataTypeEnum primitiveDataType) {
  ...
  public ExtendedPropertyKeyCreate category(String category) {
    this.category = category;
    return this;
  }

  /**
   * Category. Used for permissioning and filtering. Automatically set to &#x27;None&#x27; if not
   * specified
   *
   * @return category
   **/
  ...
  public ExtendedPropertyKeyCreate description(String description) {
  ...
  public ExtendedPropertyKeyCreate spaceId(UUID spaceId) {
  ...
  public ExtendedPropertyKeyCreate scope(ScopeEnum scope) {
    this.scope = scope;
    return this;
  }
  ...
  public ExtendedPropertyKeyCreate validationData(String validationData) {
  ...
  public ExtendedPropertyKeyCreate min(String min) {
    this.min = min;
    return this;
  }
  ...
  public ExtendedPropertyKeyCreate max(String max) {
    this.max = max;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final ExtendedPropertyKeyCreate extendedPropertyKeyCreate = (ExtendedPropertyKeyCreate) o;
    return Objects.equals(this.name, extendedPropertyKeyCreate.name)
        && Objects.equals(this.primitiveDataType, extendedPropertyKeyCreate.primitiveDataType)
        && Objects.equals(this.category, extendedPropertyKeyCreate.category)
        && Objects.equals(this.description, extendedPropertyKeyCreate.description)
        && Objects.equals(this.spaceId, extendedPropertyKeyCreate.spaceId)
        && Objects.equals(this.scope, extendedPropertyKeyCreate.scope)
        && Objects.equals(this.validationData, extendedPropertyKeyCreate.validationData)
        && Objects.equals(this.min, extendedPropertyKeyCreate.min)
        && Objects.equals(this.max, extendedPropertyKeyCreate.max);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(name, primitiveDataType, category, description, spaceId, scope,
        validationData, min, max);
  }

  @Override
  public String toString() {
    final StringBuilder sb = new StringBuilder();
    sb.append("class ExtendedPropertyKeyCreate {\n");
