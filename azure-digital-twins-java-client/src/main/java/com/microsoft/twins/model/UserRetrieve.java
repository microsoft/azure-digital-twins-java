...
public class UserRetrieve {
  ...
  public UserRetrieve id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public UserRetrieve upn(String upn) {
    this.upn = upn;
    return this;
  }

  /**
   * User Principal Name, e.g. user@domain
   *
   * @return upn
   **/
  @NotNull
  ...
  public UserRetrieve location(Location location) {
  ...
  public UserRetrieve firstName(String firstName) {
  ...
  public UserRetrieve lastName(String lastName) {
  ...
  public UserRetrieve managerName(String managerName) {
  ...
  public UserRetrieve metadata(java.util.Map<String, String> metadata) {
    this.metadata = metadata;
    return this;
  }

  public UserRetrieve putMetadataItem(String key, String metadataItem) {
  ...
  /**
   * User metadata such as skills, interests, etc.
   *
   * @return metadata
   **/
  ...
  public UserRetrieve effectiveLocation(Location effectiveLocation) {
  ...
  public UserRetrieve spaceId(UUID spaceId) {
  ...
  public UserRetrieve space(SpaceRetrieve space) {
    this.space = space;
    return this;
  }
  ...
  public UserRetrieve photoUri(String photoUri) {
    this.photoUri = photoUri;
    return this;
  }

  /**
   * Uri to the user&#x27;s picture thumbnail
   *
   * @return photoUri
   **/
  ...
  public UserRetrieve fullName(String fullName) {
  ...
  public UserRetrieve spacePaths(java.util.List<String> spacePaths) {
    this.spacePaths = spacePaths;
    return this;
  }

  public UserRetrieve addSpacePathsItem(String spacePathsItem) {
  ...
  public UserRetrieve properties(java.util.List<ExtendedPropertyRetrieve> properties) {
    this.properties = properties;
    return this;
  }

  public UserRetrieve addPropertiesItem(ExtendedPropertyRetrieve propertiesItem) {
  ...
  public UserRetrieve roleAssignments(java.util.List<RoleAssignmentRetrieve> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public UserRetrieve addRoleAssignmentsItem(RoleAssignmentRetrieve roleAssignmentsItem) {
  ...
  /**
   * The role assignments associated with the user.
   *
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final UserRetrieve userRetrieve = (UserRetrieve) o;
    return Objects.equals(this.id, userRetrieve.id) && Objects.equals(this.upn, userRetrieve.upn)
        && Objects.equals(this.location, userRetrieve.location)
        && Objects.equals(this.firstName, userRetrieve.firstName)
        && Objects.equals(this.lastName, userRetrieve.lastName)
        && Objects.equals(this.managerName, userRetrieve.managerName)
        && Objects.equals(this.metadata, userRetrieve.metadata)
        && Objects.equals(this.effectiveLocation, userRetrieve.effectiveLocation)
        && Objects.equals(this.spaceId, userRetrieve.spaceId)
        && Objects.equals(this.space, userRetrieve.space)
        && Objects.equals(this.photoUri, userRetrieve.photoUri)
        && Objects.equals(this.fullName, userRetrieve.fullName)
        && Objects.equals(this.spacePaths, userRetrieve.spacePaths)
        && Objects.equals(this.properties, userRetrieve.properties)
        && Objects.equals(this.roleAssignments, userRetrieve.roleAssignments);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, upn, location, firstName, lastName, managerName, metadata,
        effectiveLocation, spaceId, space, photoUri, fullName, spacePaths, properties,
        roleAssignments);
  }
