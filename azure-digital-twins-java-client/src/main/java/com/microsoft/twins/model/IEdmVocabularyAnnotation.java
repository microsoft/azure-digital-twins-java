...
public class IEdmVocabularyAnnotation {
  ...
  public IEdmVocabularyAnnotation target(IEdmVocabularyAnnotatable target) {
    this.target = target;
    return this;
  }
   ...
   **/
  @Valid
  public IEdmVocabularyAnnotatable getTarget() {
    return target;
  }

  public void setTarget(IEdmVocabularyAnnotatable target) {
    this.target = target;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final IEdmVocabularyAnnotation iedmVocabularyAnnotation = (IEdmVocabularyAnnotation) o;
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(qualifier, term, target);
  }
