...
public class RangeVariable {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final RangeVariable rangeVariable = (RangeVariable) o;
    return Objects.equals(this.name, rangeVariable.name)
        && Objects.equals(this.typeReference, rangeVariable.typeReference)
        && Objects.equals(this.kind, rangeVariable.kind);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(name, typeReference, kind);
  }
