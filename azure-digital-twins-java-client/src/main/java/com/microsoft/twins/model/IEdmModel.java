...
public class IEdmModel {
  ...
  private java.util.List<IEdmSchemaElement> schemaElements;
  @JsonProperty("vocabularyAnnotations")
  private java.util.List<IEdmVocabularyAnnotation> vocabularyAnnotations;
  @JsonProperty("referencedModels")
  private java.util.List<IEdmModel> referencedModels;
  @JsonProperty("directValueAnnotationsManager")
  private IEdmDirectValueAnnotationsManager directValueAnnotationsManager;
   ...
   **/
  @Valid
  public java.util.List<IEdmSchemaElement> getSchemaElements() {
    return schemaElements;
  }
   ...
   **/
  @Valid
  public java.util.List<IEdmVocabularyAnnotation> getVocabularyAnnotations() {
    return vocabularyAnnotations;
  }
   ...
   **/
  @Valid
  public java.util.List<IEdmModel> getReferencedModels() {
    return referencedModels;
  }

  public IEdmModel directValueAnnotationsManager(
   ...
   **/
  @Valid
  public IEdmDirectValueAnnotationsManager getDirectValueAnnotationsManager() {
    return directValueAnnotationsManager;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final IEdmModel iedmModel = (IEdmModel) o;
    return Objects.equals(this.schemaElements, iedmModel.schemaElements)
        ...
        && Objects.equals(this.referencedModels, iedmModel.referencedModels) && Objects
            .equals(this.directValueAnnotationsManager, iedmModel.directValueAnnotationsManager);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(schemaElements, vocabularyAnnotations, referencedModels,
  ...
  public String toString() {
    ...
    sb.append("    vocabularyAnnotations: ").append(toIndentedString(vocabularyAnnotations))
        .append("\n");
    sb.append("    referencedModels: ").append(toIndentedString(referencedModels)).append("\n");
    sb.append("    directValueAnnotationsManager: ")
        .append(toIndentedString(directValueAnnotationsManager)).append("\n");
    sb.append("}");
    return sb.toString();
  }
