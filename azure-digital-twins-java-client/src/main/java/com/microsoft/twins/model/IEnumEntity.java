 ...
 * IEnumEntity
 */
public class IEnumEntity {
  @JsonProperty("id")
  private Integer id;
  @JsonProperty("name")
  private String name;

  public IEnumEntity id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  public IEnumEntity name(String name) {
    this.name = name;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final IEnumEntity ienumEntity = (IEnumEntity) o;
    return Objects.equals(this.id, ienumEntity.id) && Objects.equals(this.name, ienumEntity.name);
  }
