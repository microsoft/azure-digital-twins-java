...
public class ODataRawQueryOptions {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final ODataRawQueryOptions odataRawQueryOptions = (ODataRawQueryOptions) o;
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(filter, orderBy, top, skip, select, expand, inlineCount, format,
        skipToken);
  }
