...
public class DeviceRetrieve {
  ...
  private OffsetDateTime connectionStateUpdatedTime;
  @JsonProperty("ioTHubUrl")
  ...
  @JsonProperty("iotHubResource")
  private SpaceResourceRetrieve iotHubResource;
  @JsonProperty("roleAssignments")
  private java.util.List<RoleAssignmentRetrieve> roleAssignments;

  public DeviceRetrieve name(String name) {
    this.name = name;
    return this;
  }
  ...
  public DeviceRetrieve friendlyName(String friendlyName) {
  ...
  public DeviceRetrieve description(String description) {
  ...
  public DeviceRetrieve type(String type) {
    this.type = type;
    return this;
  }
  ...
  public DeviceRetrieve subtype(String subtype) {
  ...
  public DeviceRetrieve typeId(Integer typeId) {
    this.typeId = typeId;
    return this;
  }
  ...
  public DeviceRetrieve subtypeId(Integer subtypeId) {
    this.subtypeId = subtypeId;
    return this;
  }

  /**
   * Device subtype identifier
   *
   * @return subtypeId
   **/
  @NotNull
  ...
  public DeviceRetrieve hardwareId(String hardwareId) {
    this.hardwareId = hardwareId;
    return this;
  }

  /**
   * Hardware unique identifier, such as MAC address.
   *
   * @return hardwareId
   **/
  @NotNull
  ...
  public DeviceRetrieve gatewayId(String gatewayId) {
    this.gatewayId = gatewayId;
    return this;
  }

  /**
   * Optional free-form gateway identifier
   *
   * @return gatewayId
   **/
  ...
  public DeviceRetrieve spaceId(UUID spaceId) {
  ...
  public DeviceRetrieve status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public DeviceRetrieve location(Location location) {
  ...
  public DeviceRetrieve id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public DeviceRetrieve connectionState(ConnectionStateEnum connectionState) {
  ...
  public DeviceRetrieve connectionStateUpdatedTime(OffsetDateTime connectionStateUpdatedTime) {
    this.connectionStateUpdatedTime = connectionStateUpdatedTime;
    return this;
  }

  /**
   * The time when {ModernIoT.Data.DataModel.DeviceRetrieve.ConnectionState} was last updated.
   *
   * @return connectionStateUpdatedTime
   **/
  @Valid
  public OffsetDateTime getConnectionStateUpdatedTime() {
    return connectionStateUpdatedTime;
  }

  public void setConnectionStateUpdatedTime(OffsetDateTime connectionStateUpdatedTime) {
    this.connectionStateUpdatedTime = connectionStateUpdatedTime;
  }

  public DeviceRetrieve ioTHubUrl(String ioTHubUrl) {
  ...
  public DeviceRetrieve deviceKey(String deviceKey) {
    this.deviceKey = deviceKey;
    return this;
  }

  /**
   * The IoT hub device key
   *
   * @return deviceKey
   **/
  ...
  public DeviceRetrieve sasToken(String sasToken) {
    this.sasToken = sasToken;
    return this;
  }

  /**
   * The IoT hub SAS token
   *
   * @return sasToken
   **/
  ...
  public DeviceRetrieve connectionString(String connectionString) {
  ...
  public DeviceRetrieve space(SpaceRetrieve space) {
    this.space = space;
    return this;
  }
  ...
  public void setSpace(SpaceRetrieve space) {
    this.space = space;
  }

  public DeviceRetrieve sensors(java.util.List<SensorRetrieve> sensors) {
    this.sensors = sensors;
    return this;
  }

  public DeviceRetrieve addSensorsItem(SensorRetrieve sensorsItem) {
  ...
  public DeviceRetrieve fullName(String fullName) {
  ...
  public DeviceRetrieve spacePaths(java.util.List<String> spacePaths) {
    this.spacePaths = spacePaths;
    return this;
  }

  public DeviceRetrieve addSpacePathsItem(String spacePathsItem) {
  ...
  public DeviceRetrieve effectiveLocation(Location effectiveLocation) {
  ...
  public DeviceRetrieve properties(java.util.List<ExtendedPropertyRetrieve> properties) {
    this.properties = properties;
    return this;
  }

  public DeviceRetrieve addPropertiesItem(ExtendedPropertyRetrieve propertiesItem) {
  ...
  public DeviceRetrieve iotHubResource(SpaceResourceRetrieve iotHubResource) {
    this.iotHubResource = iotHubResource;
    return this;
  }
   ...
   **/
  @Valid
  public SpaceResourceRetrieve getIotHubResource() {
    return iotHubResource;
  }

  public void setIotHubResource(SpaceResourceRetrieve iotHubResource) {
    this.iotHubResource = iotHubResource;
  }

  public DeviceRetrieve roleAssignments(java.util.List<RoleAssignmentRetrieve> roleAssignments) {
    this.roleAssignments = roleAssignments;
    return this;
  }

  public DeviceRetrieve addRoleAssignmentsItem(RoleAssignmentRetrieve roleAssignmentsItem) {
    if (this.roleAssignments == null) {
      this.roleAssignments = new java.util.ArrayList<>();
    }
  ...
  /**
   * The role assignments associated with the device.
   *
   * @return roleAssignments
   **/
  @Valid
  public java.util.List<RoleAssignmentRetrieve> getRoleAssignments() {
    return roleAssignments;
  }

  public void setRoleAssignments(java.util.List<RoleAssignmentRetrieve> roleAssignments) {
    this.roleAssignments = roleAssignments;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final DeviceRetrieve deviceRetrieve = (DeviceRetrieve) o;
    return Objects.equals(this.name, deviceRetrieve.name)
        && Objects.equals(this.friendlyName, deviceRetrieve.friendlyName)
        && Objects.equals(this.description, deviceRetrieve.description)
        && Objects.equals(this.type, deviceRetrieve.type)
        && Objects.equals(this.subtype, deviceRetrieve.subtype)
        && Objects.equals(this.typeId, deviceRetrieve.typeId)
        && Objects.equals(this.subtypeId, deviceRetrieve.subtypeId)
        && Objects.equals(this.hardwareId, deviceRetrieve.hardwareId)
        && Objects.equals(this.gatewayId, deviceRetrieve.gatewayId)
        && Objects.equals(this.spaceId, deviceRetrieve.spaceId)
        && Objects.equals(this.status, deviceRetrieve.status)
        && Objects.equals(this.location, deviceRetrieve.location)
        && Objects.equals(this.id, deviceRetrieve.id)
        && Objects.equals(this.connectionState, deviceRetrieve.connectionState)
        && Objects.equals(this.connectionStateUpdatedTime,
            deviceRetrieve.connectionStateUpdatedTime)
        && Objects.equals(this.ioTHubUrl, deviceRetrieve.ioTHubUrl)
        && Objects.equals(this.deviceKey, deviceRetrieve.deviceKey)
        && Objects.equals(this.sasToken, deviceRetrieve.sasToken)
        && Objects.equals(this.connectionString, deviceRetrieve.connectionString)
        && Objects.equals(this.space, deviceRetrieve.space)
        && Objects.equals(this.sensors, deviceRetrieve.sensors)
        && Objects.equals(this.fullName, deviceRetrieve.fullName)
        && Objects.equals(this.spacePaths, deviceRetrieve.spacePaths)
        && Objects.equals(this.effectiveLocation, deviceRetrieve.effectiveLocation)
        && Objects.equals(this.properties, deviceRetrieve.properties)
        && Objects.equals(this.iotHubResource, deviceRetrieve.iotHubResource)
        && Objects.equals(this.roleAssignments, deviceRetrieve.roleAssignments);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(name, friendlyName, description, type, subtype, typeId, subtypeId,
        hardwareId, gatewayId, spaceId, status, location, id, connectionState,
        connectionStateUpdatedTime, ioTHubUrl, deviceKey, sasToken, connectionString, space,
        sensors, fullName, spacePaths, effectiveLocation, properties, iotHubResource,
        roleAssignments);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeviceRetrieve {\n");
    ...
    sb.append("    connectionStateUpdatedTime: ")
        .append(toIndentedString(connectionStateUpdatedTime)).append("\n");
    sb.append("    ioTHubUrl: ").append(toIndentedString(ioTHubUrl)).append("\n");
    ...
    sb.append("    iotHubResource: ").append(toIndentedString(iotHubResource)).append("\n");
