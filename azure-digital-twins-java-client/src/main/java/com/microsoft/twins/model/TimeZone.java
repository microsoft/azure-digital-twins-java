...
public class TimeZone {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, timeZone.id) && Objects.equals(this.name, timeZone.name)
        && Objects.equals(this.accessControlPath, timeZone.accessControlPath)
        && Objects.equals(this.friendlyPath, timeZone.friendlyPath)
        && Objects.equals(this.accessControlType, timeZone.accessControlType);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, name, accessControlPath, friendlyPath, accessControlType);
  }
