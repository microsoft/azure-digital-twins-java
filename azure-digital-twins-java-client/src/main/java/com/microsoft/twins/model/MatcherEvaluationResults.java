 ...
 */
public class MatcherEvaluationResults {
  @JsonProperty("success")
  private Boolean success;
  @JsonProperty("logs")
  private java.util.List<String> logs;

  public MatcherEvaluationResults success(Boolean success) {
    this.success = success;
    return this;
  }

  /**
   * Matcher evaluation result
   *
   * @return success
   **/
  ...
  public MatcherEvaluationResults logs(java.util.List<String> logs) {
    this.logs = logs;
    return this;
  }

  public MatcherEvaluationResults addLogsItem(String logsItem) {
    if (this.logs == null) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final MatcherEvaluationResults matcherEvaluationResults = (MatcherEvaluationResults) o;
    return Objects.equals(this.success, matcherEvaluationResults.success)
        && Objects.equals(this.logs, matcherEvaluationResults.logs);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(success, logs);
  }

  @Override
  public String toString() {
    final StringBuilder sb = new StringBuilder();
    sb.append("class MatcherEvaluationResults {\n");
