...
public class SpaceCreate {
  ...
  private java.util.List<SpaceCreate> children;
  @JsonProperty("users")
  private java.util.List<UserCreate> users;
  ...
  public SpaceCreate properties(final java.util.List<ExtendedPropertyCreate> properties) {
    this.properties = properties;
    return this;
  }

  public SpaceCreate addPropertiesItem(final ExtendedPropertyCreate propertiesItem) {
  ...
  /**
   * Optional time zone name. Cannot specify both TimeZoneId and TimeZoneName.
   *
   * @return timeZoneName
   **/
  ...
  public SpaceCreate children(final java.util.List<SpaceCreate> children) {
    this.children = children;
    return this;
  }

  public SpaceCreate addChildrenItem(final SpaceCreate childrenItem) {
   ...
   **/
  @Valid
  public java.util.List<SpaceCreate> getChildren() {
    return children;
  }

  public void setChildren(final java.util.List<SpaceCreate> children) {
    this.children = children;
  }

  public SpaceCreate users(final java.util.List<UserCreate> users) {
    this.users = users;
    return this;
  }

  public SpaceCreate addUsersItem(final UserCreate usersItem) {
    if (this.users == null) {
   ...
   **/
  @Valid
  public java.util.List<UserCreate> getUsers() {
    return users;
  }

  public void setUsers(final java.util.List<UserCreate> users) {
    this.users = users;
  }
  ...
  public boolean equals(final java.lang.Object o) {
    ...
    final SpaceCreate spaceCreate = (SpaceCreate) o;
    return Objects.equals(this.name, spaceCreate.name)
        && Objects.equals(this.description, spaceCreate.description)
        && Objects.equals(this.friendlyName, spaceCreate.friendlyName)
        && Objects.equals(this.type, spaceCreate.type)
        && Objects.equals(this.typeId, spaceCreate.typeId)
        && Objects.equals(this.parentSpaceId, spaceCreate.parentSpaceId)
        && Objects.equals(this.subtype, spaceCreate.subtype)
        && Objects.equals(this.subtypeId, spaceCreate.subtypeId)
        && Objects.equals(this.location, spaceCreate.location)
        && Objects.equals(this.timeZoneId, spaceCreate.timeZoneId)
        && Objects.equals(this.status, spaceCreate.status)
        && Objects.equals(this.statusId, spaceCreate.statusId)
        && Objects.equals(this.properties, spaceCreate.properties)
        && Objects.equals(this.timeZoneName, spaceCreate.timeZoneName)
        && Objects.equals(this.children, spaceCreate.children)
        && Objects.equals(this.users, spaceCreate.users);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(name, description, friendlyName, type, typeId, parentSpaceId,
        subtype, subtypeId, location, timeZoneId, status, statusId, properties, timeZoneName,
        children, users);
  }
