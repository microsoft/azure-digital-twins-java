...
public class SensorValue {
  ...
  private java.util.List<SensorHistoryValue> historicalValues;

  public SensorValue type(String type) {
    this.type = type;
    return this;
  }
  ...
  public SensorValue value(String value) {
    this.value = value;
    return this;
  }
  ...
  public SensorValue timestamp(OffsetDateTime timestamp) {
    this.timestamp = timestamp;
    return this;
  }

  /**
   * Last updated date and time in UTC.
   *
   * @return timestamp
   **/
  @Valid
  ...
  public SensorValue historicalValues(java.util.List<SensorHistoryValue> historicalValues) {
    this.historicalValues = historicalValues;
    return this;
  }

  public SensorValue addHistoricalValuesItem(SensorHistoryValue historicalValuesItem) {
    if (this.historicalValues == null) {
      this.historicalValues = new java.util.ArrayList<>();
    }
    this.historicalValues.add(historicalValuesItem);
    return this;
  }

  /**
   * Historical values of the sensor.
   *
   * @return historicalValues
   **/
  @Valid
  public java.util.List<SensorHistoryValue> getHistoricalValues() {
    return historicalValues;
  }

  public void setHistoricalValues(java.util.List<SensorHistoryValue> historicalValues) {
    this.historicalValues = historicalValues;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final SensorValue sensorValue = (SensorValue) o;
    return Objects.equals(this.type, sensorValue.type)
        && Objects.equals(this.value, sensorValue.value)
        && Objects.equals(this.timestamp, sensorValue.timestamp)
        && Objects.equals(this.historicalValues, sensorValue.historicalValues);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(type, value, timestamp, historicalValues);
  }
  ...
  public String toString() {
    ...
    sb.append("    historicalValues: ").append(toIndentedString(historicalValues)).append("\n");
    sb.append("}");
    return sb.toString();
  }
