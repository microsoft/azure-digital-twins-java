...
public class ExtendedTypeCreate {
  ...
  public ExtendedTypeCreate category(CategoryEnum category) {
  ...
  public ExtendedTypeCreate spaceId(UUID spaceId) {
  ...
  public ExtendedTypeCreate name(String name) {
    this.name = name;
    return this;
  }

  /**
   * Type name. Must be unique for the given space and category. Can only contain alphanumeric or
  ...
  public ExtendedTypeCreate friendlyName(String friendlyName) {
  ...
  public ExtendedTypeCreate description(String description) {
  ...
  public ExtendedTypeCreate disabled(Boolean disabled) {
  ...
  public ExtendedTypeCreate logicalOrder(Integer logicalOrder) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final ExtendedTypeCreate extendedTypeCreate = (ExtendedTypeCreate) o;
    return Objects.equals(this.category, extendedTypeCreate.category)
        && Objects.equals(this.spaceId, extendedTypeCreate.spaceId)
        && Objects.equals(this.name, extendedTypeCreate.name)
        && Objects.equals(this.friendlyName, extendedTypeCreate.friendlyName)
        && Objects.equals(this.description, extendedTypeCreate.description)
        && Objects.equals(this.disabled, extendedTypeCreate.disabled)
        && Objects.equals(this.logicalOrder, extendedTypeCreate.logicalOrder);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(category, spaceId, name, friendlyName, description, disabled,
        logicalOrder);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExtendedTypeCreate {\n");
