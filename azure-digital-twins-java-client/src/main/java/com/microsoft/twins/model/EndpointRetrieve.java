...
public class EndpointRetrieve {
  ...
  private java.util.List<EventTypesEnum> eventTypes = new java.util.ArrayList<>();
  ...
  public EndpointRetrieve id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public EndpointRetrieve lastUpdatedUtc(OffsetDateTime lastUpdatedUtc) {
    this.lastUpdatedUtc = lastUpdatedUtc;
    return this;
  }

  /**
   * Last UTC date and time the endpoint was updated
   *
  ...
  public EndpointRetrieve status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public EndpointRetrieve type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public EndpointRetrieve eventTypes(java.util.List<EventTypesEnum> eventTypes) {
    this.eventTypes = eventTypes;
    return this;
  }

  public EndpointRetrieve addEventTypesItem(EventTypesEnum eventTypesItem) {
    this.eventTypes.add(eventTypesItem);
    return this;
  }

  /**
   * Type of events to send to this endpoint
   *
   * @return eventTypes
   **/
  @NotNull
  ...
  public EndpointRetrieve connectionString(String connectionString) {
    this.connectionString = connectionString;
    return this;
  }

  /**
   * Endpoint&#x27;s primary key or primary connection string
   *
  ...
  public EndpointRetrieve secondaryConnectionString(String secondaryConnectionString) {
    this.secondaryConnectionString = secondaryConnectionString;
    return this;
  }

  /**
   * Endpoint&#x27;s secondary key or secondary connection string
   *
  ...
  public EndpointRetrieve path(String path) {
    this.path = path;
    return this;
  }

  /**
   * Path to the endpoint, for example TopicName or EventHubName
   *
   * @return path
   **/
  ...
  public EndpointRetrieve properties(java.util.Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public EndpointRetrieve putPropertiesItem(String key, String propertiesItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final EndpointRetrieve endpointRetrieve = (EndpointRetrieve) o;
    return Objects.equals(this.id, endpointRetrieve.id)
        && Objects.equals(this.lastUpdatedUtc, endpointRetrieve.lastUpdatedUtc)
        && Objects.equals(this.status, endpointRetrieve.status)
        && Objects.equals(this.type, endpointRetrieve.type)
        && Objects.equals(this.eventTypes, endpointRetrieve.eventTypes)
        && Objects.equals(this.connectionString, endpointRetrieve.connectionString)
        && Objects.equals(this.secondaryConnectionString,
            endpointRetrieve.secondaryConnectionString)
        && Objects.equals(this.path, endpointRetrieve.path)
        && Objects.equals(this.properties, endpointRetrieve.properties);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, lastUpdatedUtc, status, type, eventTypes, connectionString,
        secondaryConnectionString, path, properties);
  }

  @Override
  public String toString() {
    final StringBuilder sb = new StringBuilder();
    sb.append("class EndpointRetrieve {\n");
    ...
    sb.append("    secondaryConnectionString: ").append(toIndentedString(secondaryConnectionString))
        .append("\n");
