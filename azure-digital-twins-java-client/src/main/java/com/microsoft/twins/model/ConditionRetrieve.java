 ...
 * ConditionRetrieve
 */
public class ConditionRetrieve {
  @JsonProperty("id")
  private UUID id;
  ...
  public ConditionRetrieve id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public ConditionRetrieve target(TargetEnum target) {
    this.target = target;
    return this;
  }
  ...
  public ConditionRetrieve path(String path) {
    this.path = path;
    return this;
  }

  /**
   * Case sensitive JSON path which is evaluated against the target
   *
   * @return path
   **/
  ...
  public ConditionRetrieve value(String value) {
    this.value = value;
    return this;
  }
  ...
  public ConditionRetrieve comparison(ComparisonEnum comparison) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final ConditionRetrieve conditionRetrieve = (ConditionRetrieve) o;
    return Objects.equals(this.id, conditionRetrieve.id)
        && Objects.equals(this.target, conditionRetrieve.target)
        && Objects.equals(this.path, conditionRetrieve.path)
        && Objects.equals(this.value, conditionRetrieve.value)
        && Objects.equals(this.comparison, conditionRetrieve.comparison);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConditionRetrieve {\n");
