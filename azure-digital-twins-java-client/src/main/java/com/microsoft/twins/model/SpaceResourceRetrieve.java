 ...
 */
public class SpaceResourceRetrieve {
  @JsonProperty("id")
  private UUID id;
  ...
  @JsonProperty("dependentChildren")
  private java.util.List<SpaceResourceRetrieve> dependentChildren;
  @JsonProperty("dependentAncestors")
  private java.util.List<SpaceResourceRetrieve> dependentAncestors;
  @JsonProperty("instanceNum")
  private Integer instanceNum;

  public SpaceResourceRetrieve id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public SpaceResourceRetrieve spaceId(UUID spaceId) {
  ...
  public SpaceResourceRetrieve type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public SpaceResourceRetrieve size(SizeEnum size) {
    this.size = size;
    return this;
  }
  ...
  public SpaceResourceRetrieve region(RegionEnum region) {
    this.region = region;
    return this;
  }
  ...
  public SpaceResourceRetrieve isExternallyCreated(Boolean isExternallyCreated) {
  ...
  public void setIsExternallyCreated(Boolean isExternallyCreated) {
    this.isExternallyCreated = isExternallyCreated;
  }

  public SpaceResourceRetrieve parameters(java.util.Map<String, String> parameters) {
    this.parameters = parameters;
    return this;
  }

  public SpaceResourceRetrieve putParametersItem(String key, String parametersItem) {
  ...
  public SpaceResourceRetrieve space(SpaceRetrieve space) {
    this.space = space;
    return this;
  }
  ...
  public SpaceResourceRetrieve status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public SpaceResourceRetrieve fullName(String fullName) {
  ...
  public SpaceResourceRetrieve spacePaths(java.util.List<String> spacePaths) {
    this.spacePaths = spacePaths;
    return this;
  }

  public SpaceResourceRetrieve addSpacePathsItem(String spacePathsItem) {
  ...
  public SpaceResourceRetrieve lastLog(String lastLog) {
    this.lastLog = lastLog;
    return this;
  }

  /**
   * Last line of log entry
   *
   * @return lastLog
   **/
  ...
  public SpaceResourceRetrieve lastUpdatedUtc(OffsetDateTime lastUpdatedUtc) {
  ...
  public SpaceResourceRetrieve properties(java.util.Map<String, String> properties) {
    this.properties = properties;
    return this;
  }

  public SpaceResourceRetrieve putPropertiesItem(String key, String propertiesItem) {
  ...
  public SpaceResourceRetrieve dependentChildren(
      java.util.List<SpaceResourceRetrieve> dependentChildren) {
    this.dependentChildren = dependentChildren;
    return this;
  }

  public SpaceResourceRetrieve addDependentChildrenItem(
      SpaceResourceRetrieve dependentChildrenItem) {
    if (this.dependentChildren == null) {
      this.dependentChildren = new java.util.ArrayList<>();
    }
    this.dependentChildren.add(dependentChildrenItem);
    return this;
  }

  /**
   * List of resources the current resource is dependending on
   *
   * @return dependentChildren
   **/
  @Valid
  public java.util.List<SpaceResourceRetrieve> getDependentChildren() {
    return dependentChildren;
  }

  public void setDependentChildren(java.util.List<SpaceResourceRetrieve> dependentChildren) {
    this.dependentChildren = dependentChildren;
  }

  public SpaceResourceRetrieve dependentAncestors(
      java.util.List<SpaceResourceRetrieve> dependentAncestors) {
    this.dependentAncestors = dependentAncestors;
    return this;
  }

  public SpaceResourceRetrieve addDependentAncestorsItem(
      SpaceResourceRetrieve dependentAncestorsItem) {
    if (this.dependentAncestors == null) {
      this.dependentAncestors = new java.util.ArrayList<>();
    }
    this.dependentAncestors.add(dependentAncestorsItem);
    return this;
  }

  /**
   * List of resources that are depending on the current resource
   *
   * @return dependentAncestors
   **/
  @Valid
  public java.util.List<SpaceResourceRetrieve> getDependentAncestors() {
    return dependentAncestors;
  }

  public void setDependentAncestors(java.util.List<SpaceResourceRetrieve> dependentAncestors) {
    this.dependentAncestors = dependentAncestors;
  }

  public SpaceResourceRetrieve instanceNum(Integer instanceNum) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final SpaceResourceRetrieve spaceResourceRetrieve = (SpaceResourceRetrieve) o;
    return Objects.equals(this.id, spaceResourceRetrieve.id)
        && Objects.equals(this.spaceId, spaceResourceRetrieve.spaceId)
        && Objects.equals(this.type, spaceResourceRetrieve.type)
        && Objects.equals(this.size, spaceResourceRetrieve.size)
        && Objects.equals(this.region, spaceResourceRetrieve.region)
        && Objects.equals(this.isExternallyCreated, spaceResourceRetrieve.isExternallyCreated)
        && Objects.equals(this.parameters, spaceResourceRetrieve.parameters)
        && Objects.equals(this.space, spaceResourceRetrieve.space)
        && Objects.equals(this.status, spaceResourceRetrieve.status)
        && Objects.equals(this.fullName, spaceResourceRetrieve.fullName)
        && Objects.equals(this.spacePaths, spaceResourceRetrieve.spacePaths)
        && Objects.equals(this.lastLog, spaceResourceRetrieve.lastLog)
        && Objects.equals(this.lastUpdatedUtc, spaceResourceRetrieve.lastUpdatedUtc)
        && Objects.equals(this.properties, spaceResourceRetrieve.properties)
        && Objects.equals(this.dependentChildren, spaceResourceRetrieve.dependentChildren)
        && Objects.equals(this.dependentAncestors, spaceResourceRetrieve.dependentAncestors)
        && Objects.equals(this.instanceNum, spaceResourceRetrieve.instanceNum);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, spaceId, type, size, region, isExternallyCreated, parameters,
        space, status, fullName, spacePaths, lastLog, lastUpdatedUtc, properties, dependentChildren,
        dependentAncestors, instanceNum);
  }

  @Override
  public String toString() {
    final StringBuilder sb = new StringBuilder();
    sb.append("class SpaceResourceRetrieve {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    spaceId: ").append(toIndentedString(spaceId)).append("\n");
    sb.append("    type: ").append(toIndentedString(type)).append("\n");
    sb.append("    size: ").append(toIndentedString(size)).append("\n");
    sb.append("    region: ").append(toIndentedString(region)).append("\n");
    sb.append("    isExternallyCreated: ").append(toIndentedString(isExternallyCreated))
        .append("\n");
    ...
    sb.append("    lastLog: ").append(toIndentedString(lastLog)).append("\n");
    sb.append("    lastUpdatedUtc: ").append(toIndentedString(lastUpdatedUtc)).append("\n");
    sb.append("    properties: ").append(toIndentedString(properties)).append("\n");
    sb.append("    dependentChildren: ").append(toIndentedString(dependentChildren)).append("\n");
    sb.append("    dependentAncestors: ").append(toIndentedString(dependentAncestors)).append("\n");
