...
public class DeviceCreate {
  ...
  private java.util.List<SensorCreateNoParent> sensors;
  @JsonProperty("createIoTHubDevice")
  private Boolean createIoTHubDevice;
  @JsonProperty("parentDeviceType")
  private String parentDeviceType;
  @JsonProperty("parentDeviceSubtype")
  private String parentDeviceSubtype;
  @JsonProperty("properties")
  private java.util.List<ExtendedPropertyCreate> properties;

  public DeviceCreate name(final String name) {
    this.name = name;
    return this;
  }
  ...
  public DeviceCreate friendlyName(final String friendlyName) {
  ...
  public DeviceCreate description(final String description) {
  ...
  public DeviceCreate type(final String type) {
    this.type = type;
    return this;
  }

  /**
   * Device type. Defaults to None
   *
   * @return type
   **/
  ...
  public DeviceCreate typeId(final Integer typeId) {
    this.typeId = typeId;
    return this;
  }

  /**
   * Device type identifier. Cannot specify both Type and TypeId
   *
   * @return typeId
   **/
  ...
  public DeviceCreate subtype(final String subtype) {
    this.subtype = subtype;
    return this;
  }

  /**
   * Device subtype. Defaults to None
   *
   * @return subtype
   **/
  ...
  public DeviceCreate subtypeId(final Integer subtypeId) {
    this.subtypeId = subtypeId;
    return this;
  }

  /**
   * Device subtype identifier. Cannot specify both Subtype and SubtypeId
   *
   * @return subtypeId
   **/
  ...
  public DeviceCreate hardwareId(final String hardwareId) {
  ...
  public DeviceCreate gatewayId(final String gatewayId) {
  ...
  public DeviceCreate spaceId(final UUID spaceId) {
  ...
  public DeviceCreate status(final StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public DeviceCreate location(final Location location) {
  ...
  public DeviceCreate sensors(final java.util.List<SensorCreateNoParent> sensors) {
    this.sensors = sensors;
    return this;
  }

  public DeviceCreate addSensorsItem(final SensorCreateNoParent sensorsItem) {
   ...
   **/
  @Valid
  public java.util.List<SensorCreateNoParent> getSensors() {
    return sensors;
  }

  public void setSensors(final java.util.List<SensorCreateNoParent> sensors) {
    this.sensors = sensors;
  }

  public DeviceCreate createIoTHubDevice(final Boolean createIoTHubDevice) {
    this.createIoTHubDevice = createIoTHubDevice;
    return this;
  }

  /**
   * Flag to specify that corresponding IoT Hub device should be created at the same time as the SBS
   * device. IoT Hub device can be created later by requesting the IoT Hub URL, IoT Hub connection
   * string, or device key for the device. Defaults to true.
   *
   * @return createIoTHubDevice
   **/
  public Boolean isCreateIoTHubDevice() {
    return createIoTHubDevice;
  }

  public void setCreateIoTHubDevice(final Boolean createIoTHubDevice) {
    this.createIoTHubDevice = createIoTHubDevice;
  }

  public DeviceCreate parentDeviceType(final String parentDeviceType) {
    this.parentDeviceType = parentDeviceType;
    return this;
  }

  /**
   * If specified, automatically set the device’s GatewayId to a device of the given type. Must
   * include both ParentDeviceType and ParentDeviceSubtype with a null GatewayId
   *
  ...
  public void setParentDeviceType(final String parentDeviceType) {
    this.parentDeviceType = parentDeviceType;
  }

  public DeviceCreate parentDeviceSubtype(final String parentDeviceSubtype) {
    this.parentDeviceSubtype = parentDeviceSubtype;
    return this;
  }
   ...
   * include both ParentDeviceType and ParentDeviceSubtype with a null GatewayId
   *
   * @return parentDeviceSubtype
   **/
  public String getParentDeviceSubtype() {
    return parentDeviceSubtype;
  }

  public void setParentDeviceSubtype(final String parentDeviceSubtype) {
    this.parentDeviceSubtype = parentDeviceSubtype;
  }

  public DeviceCreate properties(final java.util.List<ExtendedPropertyCreate> properties) {
    this.properties = properties;
    return this;
  }

  public DeviceCreate addPropertiesItem(final ExtendedPropertyCreate propertiesItem) {
   ...
   **/
  @Valid
  public java.util.List<ExtendedPropertyCreate> getProperties() {
    return properties;
  }

  public void setProperties(final java.util.List<ExtendedPropertyCreate> properties) {
    this.properties = properties;
  }
  ...
  public boolean equals(final java.lang.Object o) {
    ...
    final DeviceCreate deviceCreate = (DeviceCreate) o;
    return Objects.equals(this.name, deviceCreate.name)
        && Objects.equals(this.friendlyName, deviceCreate.friendlyName)
        && Objects.equals(this.description, deviceCreate.description)
        && Objects.equals(this.type, deviceCreate.type)
        && Objects.equals(this.typeId, deviceCreate.typeId)
        && Objects.equals(this.subtype, deviceCreate.subtype)
        && Objects.equals(this.subtypeId, deviceCreate.subtypeId)
        && Objects.equals(this.hardwareId, deviceCreate.hardwareId)
        && Objects.equals(this.gatewayId, deviceCreate.gatewayId)
        && Objects.equals(this.spaceId, deviceCreate.spaceId)
        && Objects.equals(this.status, deviceCreate.status)
        && Objects.equals(this.location, deviceCreate.location)
        && Objects.equals(this.sensors, deviceCreate.sensors)
        && Objects.equals(this.createIoTHubDevice, deviceCreate.createIoTHubDevice)
        && Objects.equals(this.parentDeviceType, deviceCreate.parentDeviceType)
        && Objects.equals(this.parentDeviceSubtype, deviceCreate.parentDeviceSubtype)
        && Objects.equals(this.properties, deviceCreate.properties);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(name, friendlyName, description, type, typeId, subtype, subtypeId,
        hardwareId, gatewayId, spaceId, status, location, sensors, createIoTHubDevice,
        parentDeviceType, parentDeviceSubtype, properties);
  }
  ...
  public String toString() {
    ...
    sb.append("    createIoTHubDevice: ").append(toIndentedString(createIoTHubDevice)).append("\n");
    sb.append("    parentDeviceType: ").append(toIndentedString(parentDeviceType)).append("\n");
    sb.append("    parentDeviceSubtype: ").append(toIndentedString(parentDeviceSubtype))
        .append("\n");
