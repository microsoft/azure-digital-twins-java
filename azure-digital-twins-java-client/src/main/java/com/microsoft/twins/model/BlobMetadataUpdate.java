 ...
 * BlobMetadataUpdate
 */
public class BlobMetadataUpdate {
  @JsonProperty("name")
  private String name;
  ...
  @JsonProperty("deleteOlderVersions")
  private Boolean deleteOlderVersions;

  public BlobMetadataUpdate name(String name) {
    this.name = name;
    return this;
  }
  ...
  public BlobMetadataUpdate sharing(SharingEnum sharing) {
  ...
  public BlobMetadataUpdate description(String description) {
  ...
  public BlobMetadataUpdate deleteOlderVersions(Boolean deleteOlderVersions) {
    this.deleteOlderVersions = deleteOlderVersions;
    return this;
  }

  /**
   * Get deleteOlderVersions
   *
   * @return deleteOlderVersions
   **/
  public Boolean isDeleteOlderVersions() {
    return deleteOlderVersions;
  }

  public void setDeleteOlderVersions(Boolean deleteOlderVersions) {
    this.deleteOlderVersions = deleteOlderVersions;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final BlobMetadataUpdate blobMetadataUpdate = (BlobMetadataUpdate) o;
    return Objects.equals(this.name, blobMetadataUpdate.name)
        && Objects.equals(this.sharing, blobMetadataUpdate.sharing)
        && Objects.equals(this.description, blobMetadataUpdate.description)
        && Objects.equals(this.deleteOlderVersions, blobMetadataUpdate.deleteOlderVersions);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(name, sharing, description, deleteOlderVersions);
  }

  @Override
  public String toString() {
    final StringBuilder sb = new StringBuilder();
    sb.append("class BlobMetadataUpdate {\n");
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    sharing: ").append(toIndentedString(sharing)).append("\n");
    sb.append("    description: ").append(toIndentedString(description)).append("\n");
    sb.append("    deleteOlderVersions: ").append(toIndentedString(deleteOlderVersions))
        .append("\n");
    sb.append("}");
    return sb.toString();
  }
