...
/**
 * Payload for updating a key store. TODO: should we allow moving to a different SpaceId during
 * updates?
 */
public class KeyStoreUpdate {
  @JsonProperty("name")
  private String name;
  @JsonProperty("description")
  private String description;

  public KeyStoreUpdate name(String name) {
    this.name = name;
    return this;
  }
  ...
  public KeyStoreUpdate description(String description) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final KeyStoreUpdate keyStoreUpdate = (KeyStoreUpdate) o;
    return Objects.equals(this.name, keyStoreUpdate.name)
        && Objects.equals(this.description, keyStoreUpdate.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeyStoreUpdate {\n");
