...
public class KeyStoreCreate {
  ...
  public KeyStoreCreate name(String name) {
    this.name = name;
    return this;
  }
  ...
  public KeyStoreCreate description(String description) {
  ...
  public KeyStoreCreate spaceId(UUID spaceId) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final KeyStoreCreate keyStoreCreate = (KeyStoreCreate) o;
    return Objects.equals(this.name, keyStoreCreate.name)
        && Objects.equals(this.description, keyStoreCreate.description)
        && Objects.equals(this.spaceId, keyStoreCreate.spaceId);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(name, description, spaceId);
  }

  @Override
  public String toString() {
    final StringBuilder sb = new StringBuilder();
    sb.append("class KeyStoreCreate {\n");
