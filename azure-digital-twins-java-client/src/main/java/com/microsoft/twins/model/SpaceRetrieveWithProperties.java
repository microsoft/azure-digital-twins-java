 ...
 */
public class SpaceRetrieveWithProperties {
  ...
  public SpaceRetrieveWithProperties properties(
      java.util.List<ExtendedPropertyRetrieve> properties) {
    this.properties = properties;
    return this;
  }

  public SpaceRetrieveWithProperties addPropertiesItem(ExtendedPropertyRetrieve propertiesItem) {
  ...
  public SpaceRetrieveWithProperties id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  public SpaceRetrieveWithProperties name(String name) {
    this.name = name;
    return this;
  }
  ...
  public SpaceRetrieveWithProperties description(String description) {
  ...
  public SpaceRetrieveWithProperties friendlyName(String friendlyName) {
  ...
  public SpaceRetrieveWithProperties type(String type) {
    this.type = type;
    return this;
  }
  ...
  public SpaceRetrieveWithProperties typeId(Integer typeId) {
    this.typeId = typeId;
    return this;
  }
  ...
  public SpaceRetrieveWithProperties parentSpaceId(UUID parentSpaceId) {
  ...
  public SpaceRetrieveWithProperties subtype(String subtype) {
  ...
  public SpaceRetrieveWithProperties subtypeId(Integer subtypeId) {
  ...
  public SpaceRetrieveWithProperties location(Location location) {
  ...
  public SpaceRetrieveWithProperties timeZoneId(Integer timeZoneId) {
  ...
  public SpaceRetrieveWithProperties status(String status) {
    this.status = status;
    return this;
  }
  ...
  public SpaceRetrieveWithProperties statusId(Integer statusId) {
  ...
  public SpaceRetrieveWithProperties fullName(String fullName) {
  ...
  public SpaceRetrieveWithProperties spacePaths(java.util.List<String> spacePaths) {
    this.spacePaths = spacePaths;
    return this;
  }

  public SpaceRetrieveWithProperties addSpacePathsItem(String spacePathsItem) {
  ...
  public SpaceRetrieveWithProperties effectiveLocation(Location effectiveLocation) {
  ...
  public SpaceRetrieveWithProperties effectiveTimeZoneId(Integer effectiveTimeZoneId) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final SpaceRetrieveWithProperties spaceRetrieveWithProperties = (SpaceRetrieveWithProperties) o;
    return Objects.equals(this.properties, spaceRetrieveWithProperties.properties)
        && Objects.equals(this.id, spaceRetrieveWithProperties.id)
        && Objects.equals(this.name, spaceRetrieveWithProperties.name)
        && Objects.equals(this.description, spaceRetrieveWithProperties.description)
        && Objects.equals(this.friendlyName, spaceRetrieveWithProperties.friendlyName)
        && Objects.equals(this.type, spaceRetrieveWithProperties.type)
        && Objects.equals(this.typeId, spaceRetrieveWithProperties.typeId)
        && Objects.equals(this.parentSpaceId, spaceRetrieveWithProperties.parentSpaceId)
        && Objects.equals(this.subtype, spaceRetrieveWithProperties.subtype)
        && Objects.equals(this.subtypeId, spaceRetrieveWithProperties.subtypeId)
        && Objects.equals(this.location, spaceRetrieveWithProperties.location)
        && Objects.equals(this.timeZoneId, spaceRetrieveWithProperties.timeZoneId)
        && Objects.equals(this.status, spaceRetrieveWithProperties.status)
        && Objects.equals(this.statusId, spaceRetrieveWithProperties.statusId)
        && Objects.equals(this.fullName, spaceRetrieveWithProperties.fullName)
        && Objects.equals(this.spacePaths, spaceRetrieveWithProperties.spacePaths)
        && Objects.equals(this.effectiveLocation, spaceRetrieveWithProperties.effectiveLocation)
        && Objects.equals(this.effectiveTimeZoneId,
            spaceRetrieveWithProperties.effectiveTimeZoneId);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(properties, id, name, description, friendlyName, type, typeId,
        parentSpaceId, subtype, subtypeId, location, timeZoneId, status, statusId, fullName,
        spacePaths, effectiveLocation, effectiveTimeZoneId);
  }

  @Override
  public String toString() {
    final StringBuilder sb = new StringBuilder();
    sb.append("class SpaceRetrieveWithProperties {\n");
