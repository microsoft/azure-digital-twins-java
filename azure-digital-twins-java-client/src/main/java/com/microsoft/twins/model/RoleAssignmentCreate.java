...
public class RoleAssignmentCreate {
  ...
  public RoleAssignmentCreate roleId(UUID roleId) {
    this.roleId = roleId;
    return this;
  }
  ...
  public RoleAssignmentCreate objectId(String objectId) {
  ...
  public RoleAssignmentCreate objectIdType(ObjectIdTypeEnum objectIdType) {
  ...
  public RoleAssignmentCreate tenantId(UUID tenantId) {
  ...
  public RoleAssignmentCreate path(String path) {
    this.path = path;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final RoleAssignmentCreate roleAssignmentCreate = (RoleAssignmentCreate) o;
    return Objects.equals(this.roleId, roleAssignmentCreate.roleId)
        && Objects.equals(this.objectId, roleAssignmentCreate.objectId)
        && Objects.equals(this.objectIdType, roleAssignmentCreate.objectIdType)
        && Objects.equals(this.tenantId, roleAssignmentCreate.tenantId)
        && Objects.equals(this.path, roleAssignmentCreate.path);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(roleId, objectId, objectIdType, tenantId, path);
  }
