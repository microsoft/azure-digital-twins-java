 ...
 * BlobMetadataCreate
 */
public class BlobMetadataCreate {
  @JsonProperty("name")
  private String name;
  ...
  public BlobMetadataCreate name(String name) {
    this.name = name;
    return this;
  }
  ...
  public BlobMetadataCreate parentId(UUID parentId) {
  ...
  public BlobMetadataCreate type(String type) {
    this.type = type;
    return this;
  }
  ...
  public BlobMetadataCreate subtype(String subtype) {
  ...
  public BlobMetadataCreate typeId(Integer typeId) {
    this.typeId = typeId;
    return this;
  }
  ...
  public BlobMetadataCreate subtypeId(Integer subtypeId) {
  ...
  public BlobMetadataCreate sharing(SharingEnum sharing) {
  ...
  public BlobMetadataCreate description(String description) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final BlobMetadataCreate blobMetadataCreate = (BlobMetadataCreate) o;
    return Objects.equals(this.name, blobMetadataCreate.name)
        && Objects.equals(this.parentId, blobMetadataCreate.parentId)
        && Objects.equals(this.type, blobMetadataCreate.type)
        && Objects.equals(this.subtype, blobMetadataCreate.subtype)
        && Objects.equals(this.typeId, blobMetadataCreate.typeId)
        && Objects.equals(this.subtypeId, blobMetadataCreate.subtypeId)
        && Objects.equals(this.sharing, blobMetadataCreate.sharing)
        && Objects.equals(this.description, blobMetadataCreate.description);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(name, parentId, type, subtype, typeId, subtypeId, sharing,
        description);
  }
  ...
  public String toString() {
    ...
    sb.append("class BlobMetadataCreate {\n");
