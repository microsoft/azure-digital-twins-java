...
public class Permission {
  ...
  public Permission notActions(java.util.List<String> notActions) {
  ...
  public void setNotActions(java.util.List<String> notActions) {
    this.notActions = notActions;
  }

  public Permission actions(java.util.List<String> actions) {
  ...
  public Permission condition(String condition) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.notActions, permission.notActions)
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(notActions, actions, condition);
  }
