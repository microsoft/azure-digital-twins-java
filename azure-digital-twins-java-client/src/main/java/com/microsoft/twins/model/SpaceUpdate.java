...
public class SpaceUpdate {
  ...
  public SpaceUpdate description(String description) {
  ...
  public SpaceUpdate friendlyName(String friendlyName) {
  ...
  public SpaceUpdate typeId(Integer typeId) {
    this.typeId = typeId;
    return this;
  }
  ...
  public SpaceUpdate parentSpaceId(UUID parentSpaceId) {
  ...
  public SpaceUpdate subtype(String subtype) {
  ...
  public SpaceUpdate subtypeId(Integer subtypeId) {
  ...
  public SpaceUpdate location(Location location) {
  ...
  public SpaceUpdate timeZoneId(Integer timeZoneId) {
    this.timeZoneId = timeZoneId;
    return this;
  }

  /**
   * Optional time zone identifier for the space Cannot specify both TimeZoneId and TimeZoneName
   *
   * @return timeZoneId
   **/
  ...
  public SpaceUpdate timeZoneName(String timeZoneName) {
    this.timeZoneName = timeZoneName;
    return this;
  }

  /**
   * Optional time zone name, or \&quot;None\&quot; to reset to no timezone Cannot specify both
  ...
  public SpaceUpdate statusId(Integer statusId) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    final SpaceUpdate spaceUpdate = (SpaceUpdate) o;
    return Objects.equals(this.name, spaceUpdate.name)
        && Objects.equals(this.description, spaceUpdate.description)
        && Objects.equals(this.friendlyName, spaceUpdate.friendlyName)
        && Objects.equals(this.type, spaceUpdate.type)
        && Objects.equals(this.typeId, spaceUpdate.typeId)
        && Objects.equals(this.parentSpaceId, spaceUpdate.parentSpaceId)
        && Objects.equals(this.subtype, spaceUpdate.subtype)
        && Objects.equals(this.subtypeId, spaceUpdate.subtypeId)
        && Objects.equals(this.location, spaceUpdate.location)
        && Objects.equals(this.timeZoneId, spaceUpdate.timeZoneId)
        && Objects.equals(this.timeZoneName, spaceUpdate.timeZoneName)
        && Objects.equals(this.status, spaceUpdate.status)
        && Objects.equals(this.statusId, spaceUpdate.statusId);
  }

  @Override
  public int hashCode() {
    return java.util.Objects.hash(name, description, friendlyName, type, typeId, parentSpaceId,
        subtype, subtypeId, location, timeZoneId, timeZoneName, status, statusId);
  }
