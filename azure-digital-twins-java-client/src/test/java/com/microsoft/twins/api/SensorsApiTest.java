...
public class SensorsApiTest extends AbstractApiTest {
  ...
  public void sensorsMatchersTest() {
    ...
    // java.util.List<MatcherRetrieve> response = api.sensorsMatchers(id,
    // includes);
    // TODO: test validations
  }
  ...
  public void sensorsRetrieveTest() {
    ...
    // java.util.List<SensorRetrieve> response = api.sensorsRetrieve(ids,
  ...
  public void sensorsRetrieveTestQueryMap() {
    ...
    // java.util.List<SensorRetrieve> response =
