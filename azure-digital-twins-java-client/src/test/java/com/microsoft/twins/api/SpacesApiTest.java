...
public class SpacesApiTest extends AbstractApiTest {
  ...
  public void spacesGetValueTest() {
    ...
    // java.util.List<SensorValue> response = api.spacesGetValue(id,
    // sensorDataTypes);
    // TODO: test validations
  }
  ...
  public void spacesMoveUsersToSpaceTest() {
    final java.util.List<UserCreate> body;
  ...
  public void spacesRetrieveTest() {
    ...
    // java.util.List<SpaceRetrieveWithChildren> response =
  ...
  public void spacesRetrieveUsersTest() {
    ...
    final String propertyValue;
    final String propertyValueSearchType;
    // java.util.List<UserRetrieve> response = api.spacesRetrieveUsers(id,
